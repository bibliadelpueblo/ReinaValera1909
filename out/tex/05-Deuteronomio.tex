...
\bibverse{1} Estas son las palabras que habló Moisés á todo Israel de
...
\bibverse{2} Once jornadas hay desde Horeb, camino del monte de Seir,
hasta Cades-barnea. \bibverse{3} Y fué, que á los cuarenta años, en el
...
\bibverse{4} Después que hirió á Sehón rey de los Amorrheos, que
habitaba en Hesbón, y á Og rey de Basán, que habitaba en Astarot en
Edrei: \bibverse{5} De esta parte del Jordán, en tierra de Moab,
...
\bibverse{7} Volveos, partíos é id al monte del Amorrheo, y á todas sus
...
río, el río Eufrates. \bibverse{8} Mirad, yo he dado la tierra en
...
\bibverse{9} Y yo os hablé entonces, diciendo: Yo no puedo llevaros
solo: \bibverse{10} Jehová vuestro Dios os ha multiplicado, y he aquí
sois hoy vosotros como las estrellas del cielo en multitud. \footnote{\textbf{1:10}
  Deut 10,22; Gén 15,5} \bibverse{11} ¡Jehová Dios de vuestros padres
añada sobre vosotros como sois mil veces, y os bendiga, como os ha
prometido! \bibverse{12} ¿Cómo llevaré yo solo vuestras molestias,
vuestras cargas, y vuestros pleitos? \bibverse{13} Dadme de entre
vosotros, de vuestras tribus, varones sabios y entendidos y expertos,
para que yo los ponga por vuestros jefes.

\bibverse{14} Y me respondisteis, y dijisteis: Bueno es hacer lo que has
dicho. \bibverse{15} Y tomé los principales de vuestras tribus, varones
...
gobernadores á vuestras tribus. \bibverse{16} Y entonces mandé á
...
\bibverse{17} No tengáis respeto de personas en el juicio: así al
...
yo la oiré. \footnote{\textbf{1:17} Deut 16,19; Éxod 21,6} \bibverse{18}
...
\bibverse{19} Y partidos de Horeb, anduvimos todo aquel grande y
...
Cades-barnea. \bibverse{20} Entonces os dije: Llegado habéis al monte
del Amorrheo, el cual Jehová nuestro Dios nos da. \bibverse{21} Mira,
...
\bibverse{22} Y llegasteis á mí todos vosotros, y dijisteis: Enviemos
...
\bibverse{23} Y el dicho me pareció bien: y tomé doce varones de
vosotros, un varón por tribu: \bibverse{24} Y se encaminaron, y subieron
al monte, y llegaron hasta la arroyada de Escol, y reconocieron la
tierra. \bibverse{25} Y tomaron en sus manos del fruto del país, y nos
lo trajeron, y diéronnos cuenta, y dijeron: Es buena la tierra que
Jehová nuestro Dios nos da.

\bibverse{26} Empero no quisisteis subir, antes fuisteis rebeldes al
dicho de Jehová vuestro Dios; \footnote{\textbf{1:26} Núm 14,-1}
\bibverse{27} Y murmurasteis en vuestras tiendas, diciendo: Porque
Jehová nos aborrecía, nos ha sacado de tierra de Egipto, para
entregarnos en mano del Amorrheo para destruirnos. \bibverse{28} ¿A
...
\bibverse{29} Entonces os dije: No temáis, ni tengáis miedo de ellos.
\bibverse{30} Jehová vuestro Dios, el cual va delante de vosotros, él
...
en Egipto delante de vuestros ojos; \footnote{\textbf{1:30} Éxod 14,14;
  Éxod 14,25; Jos 10,14} \bibverse{31} Y en el desierto has visto que
...
\bibverse{32} Y aun con esto no creisteis en Jehová vuestro Dios,
\bibverse{33} El cual iba delante de vosotros por el camino, para
...
\bibverse{34} Y oyó Jehová la voz de vuestras palabras, y enojóse, y
juró diciendo: \bibverse{35} No verá hombre alguno de estos de esta mala
generación, la buena tierra que juré había de dar á vuestros padres,
\bibverse{36} Excepto Caleb hijo de Jephone: él la verá, y á él le daré
la tierra que pisó, y á sus hijos; porque cumplió en pos de Jehová.

\bibverse{37} Y también contra mí se airó Jehová por vosotros, diciendo:
Tampoco tú entrarás allá: \bibverse{38} Josué hijo de Nun, que está
delante de ti, él entrará allá: anímale; porque él la hará heredar á
Israel. \footnote{\textbf{1:38} Núm 34,17} \bibverse{39} Y vuestros
...
ellos la heredarán. \bibverse{40} Y vosotros volveos, y partíos al
desierto camino del mar Bermejo.

\bibverse{41} Entonces respondisteis y me dijisteis: Pecado hemos contra
...
\bibverse{42} Y Jehová me dijo: Diles: No subáis, ni peleéis, pues no
estoy entre vosotros; porque no seáis heridos delante de vuestros
enemigos.

\bibverse{43} Y os hablé, y no disteis oído; antes fuisteis rebeldes al
dicho de Jehová, y persistiendo con altivez, subisteis al monte.
\bibverse{44} Y salió el Amorrheo, que habitaba en aquel monte, á
vuestro encuentro, y os persiguieron, como hacen las avispas, y os
derrotaron en Seir, persiguiéndoos hasta Horma. \bibverse{45} Y
volvisteis, y llorasteis delante de Jehová; pero Jehová no escuchó
vuestra voz, ni os prestó oído. \bibverse{46} Y estuvisteis en Cades por
...
\bibverse{1} Y volvimos, y partímonos al desierto camino del mar
Bermejo, como Jehová me había dicho; y rodeamos el monte de Seir por
muchos días.

\bibverse{2} Y Jehová me habló, diciendo: \bibverse{3} Harto habéis
rodeado este monte; volveos al aquilón. \bibverse{4} Y manda al pueblo,
...
vosotros guardaos mucho: \footnote{\textbf{2:4} Núm 20,14} \bibverse{5}
...
Seir. \footnote{\textbf{2:5} Gén 36,8; Gén 36,43} \bibverse{6}
Compraréis de ellos por dinero las viandas, y comeréis; y también
compraréis de ellos el agua, y beberéis:

\bibverse{7} Pues Jehová tu Dios te ha bendecido en toda obra de tus
...
\bibverse{8} Y pasamos de nuestros hermanos los hijos de Esaú, que
habitaban en Seir, por el camino de la llanura de Elath y de Esiongeber.
Y volvimos, y pasamos camino del desierto de Moab.

\bibverse{9} Y Jehová me dijo: No molestes á Moab, ni te empeñes con
...
\bibverse{10} (Los Emimeos habitaron en ella antes, pueblo grande, y
numeroso, y alto como gigantes: \footnote{\textbf{2:10} Deut 1,28}
\bibverse{11} Por gigantes eran ellos también contados, como los
Anaceos; y los Moabitas los llaman Emimeos. \bibverse{12} Y en Seir
...
\bibverse{13} Levantaos ahora, y pasad el arroyo de Zered. Y pasamos el
arroyo de Zered. \footnote{\textbf{2:13} Núm 21,12}

\bibverse{14} Y los días que anduvimos de Cades-barnea hasta que pasamos
...
\bibverse{15} Y también la mano de Jehová fué sobre ellos para
destruirlos de en medio del campo, hasta acabarlos. \bibverse{16} Y
aconteció que cuando se hubieron acabado de morir todos los hombres de
guerra de entre el pueblo, \bibverse{17} Jehová me habló, diciendo:
\bibverse{18} Tú pasarás hoy el término de Moab, á Ar, \bibverse{19} Y
...
\bibverse{20} (Por tierra de gigantes fué también ella tenida: habitaron
en ella gigantes en otro tiempo, á los cuales los Ammonitas llamaban
Zomzommeos; \bibverse{21} Pueblo grande, y numeroso, y alto, como los
Anaceos; á los cuales Jehová destruyó de delante de los Ammonitas,
quienes les sucedieron, y habitaron en su lugar: \bibverse{22} Como hizo
...
hasta hoy. \bibverse{23} Y á los Heveos que habitaban en Haserin hasta
Gaza, los Caftoreos que salieron de Caftor los destruyeron, y habitaron
en su lugar.)

\bibverse{24} Levantaos, partid, y pasad el arroyo de Arnón: he aquí he
dado en tu mano á Sehón rey de Hesbón, Amorrheo, y á su tierra: comienza
á tomar posesión, y empéñate con él en guerra. \bibverse{25} Hoy
...
\bibverse{26} Y envié mensajeros desde el desierto de Cademoth á Sehón
rey de Hesbón, con palabras de paz, diciendo: \footnote{\textbf{2:26}
  Núm 21,21-26} \bibverse{27} Pasaré por tu tierra por el camino: por el
camino iré, sin apartarme á diestra ni á siniestra: \bibverse{28} La
comida me venderás por dinero, y comeré: el agua también me darás por
dinero, y beberé: solamente pasaré á pie; \bibverse{29} Como lo hicieron
...
nuestro Dios. \bibverse{30} Mas Sehón rey de Hesbón no quiso que
...
\bibverse{31} Y díjome Jehová: He aquí yo he comenzado á dar delante de
ti á Sehón y á su tierra; comienza á tomar posesión, para que heredes su
tierra. \bibverse{32} Y saliónos Sehón al encuentro, él y todo su
pueblo, para pelear en Jaas. \bibverse{33} Mas Jehová nuestro Dios lo
entregó delante de nosotros; y herimos á él y á sus hijos, y á todo su
pueblo. \bibverse{34} Y tomamos entonces todas sus ciudades, y
destruimos todas las ciudades, hombres, y mujeres, y niños; no dejamos
ninguno: \bibverse{35} Solamente tomamos para nosotros las bestias, y
los despojos de las ciudades que habíamos tomado. \bibverse{36} Desde
...
\bibverse{37} Solamente á la tierra de los hijos de Ammón no llegaste,
...
\bibverse{1} Y volvimos, y subimos camino de Basán, y saliónos al
encuentro Og rey de Basán para pelear, él y todo su pueblo, en Edrei.
\bibverse{2} Y díjome Jehová: No tengas temor de él, porque en tu mano
...
\bibverse{3} Y Jehová nuestro Dios entregó también en nuestra mano á Og
rey de Basán, y á todo su pueblo, al cual herimos hasta no quedar de él
ninguno. \bibverse{4} Y tomamos entonces todas sus ciudades; no quedó
ciudad que no les tomásemos: sesenta ciudades, toda la tierra de Argob,
del reino de Og en Basán. \bibverse{5} Todas éstas eran ciudades
fortalecidas con alto muro, con puertas y barras; sin otras muy muchas
ciudades sin muro. \bibverse{6} Y destruímoslas, como hicimos á Sehón
rey de Hesbón, destruyendo en toda ciudad hombres, mujeres, y niños.
\bibverse{7} Y tomamos para nosotros todas las bestias, y los despojos
...
\bibverse{8} También tomamos en aquel tiempo de mano de dos reyes
Amorrheos que estaban de esta parte del Jordán, la tierra desde el
arroyo de Arnón hasta el monte de Hermón: \bibverse{9} (Los Sidonios
llaman á Hermón Sirión; y los Amorrheos, Senir:) \bibverse{10} Todas las
ciudades de la llanura, y todo Galaad, y todo Basán hasta Salchâ y
Edrei, ciudades del reino de Og en Basán. \bibverse{11} Porque sólo Og
...
de un hombre. \bibverse{12} Y esta tierra que heredamos entonces desde
...
sus ciudades, dí á los Rubenitas y á los Gaditas: \footnote{\textbf{3:12}
  Núm 32,33-42} \bibverse{13} Y el resto de Galaad, y todo Basán, del
reino de Og, dílo á la media tribu de Manasés; toda la tierra de Argob,
todo Basán, que se llamaba la tierra de los gigantes. \bibverse{14} Jair
...
\bibverse{15} Y á Machîr dí á Galaad. \bibverse{16} Y á los Rubenitas y
...
\bibverse{17} Asimismo la campiña, y el Jordán, y el término, desde
...
\bibverse{18} Y os mandé entonces, diciendo: Jehová vuestro Dios os ha
dado esta tierra para que la poseáis: pasaréis armados delante de
vuestros hermanos los hijos de Israel todos los valientes. \bibverse{19}
...
\bibverse{20} Hasta que Jehová dé reposo á vuestros hermanos, así como á
...
\bibverse{21} Mandé también á Josué entonces, diciendo: Tus ojos vieron
todo lo que Jehová vuestro Dios ha hecho á aquellos dos reyes: así hará
Jehová á todos los reinos á los cuales pasarás tú. \bibverse{22} No los
...
\bibverse{23} Y oré á Jehová en aquel tiempo, diciendo: \bibverse{24}
...
según tus obras, y según tus valentías? \bibverse{25} Pase yo, ruégote,
y vea aquella tierra buena, que está á la parte allá del Jordán, aquel
buen monte, y el Líbano.

\bibverse{26} Mas Jehová se había enojado contra mí por causa de
vosotros, por lo cual no me oyó: y díjome Jehová: Bástate, no me hables
más de este negocio. \bibverse{27} Sube á la cumbre del Pisga, y alza
tus ojos al occidente, y al aquilón, y al mediodía, y al oriente, y ve
por tus ojos: porque no pasarás este Jordán. \bibverse{28} Y manda á
...
\bibverse{1} Ahora pues, oh Israel, oye los estatutos y derechos que yo
os enseño, para que los ejecutéis, y viváis, y entréis, y poseáis la
tierra que Jehová el Dios de vuestros padres te da. \bibverse{2} No
...
\bibverse{3} Vuestros ojos vieron lo que hizo Jehová con motivo de
...
\bibverse{4} Mas vosotros que os allegasteis á Jehová vuestro Dios,
todos estáis vivos hoy. \bibverse{5} Mirad, yo os he enseñado estatutos
y derechos, como Jehová mi Dios me mandó, para que hagáis así en medio
de la tierra en la cual entráis para poseerla. \bibverse{6} Guardadlos,
...
es ésta. \bibverse{7} Porque ¿qué gente grande hay que tenga los dioses
cercanos á sí, como lo está Jehová nuestro Dios en todo cuanto le
pedimos? \bibverse{8} Y ¿qué gente grande hay que tenga estatutos y
...
\bibverse{9} Por tanto, guárdate, y guarda tu alma con diligencia, que
...
hijos de tus hijos; \footnote{\textbf{4:9} Sal 103,2} \bibverse{10} El
...
tierra: y las enseñarán á sus hijos; \footnote{\textbf{4:10} Éxod 19,17;
  Deut 6,7; Deut 11,19} \bibverse{11} Y os llegasteis, y os pusisteis al
pie del monte; y el monte ardía en fuego hasta en medio de los cielos
con tinieblas, nube, y oscuridad. \bibverse{12} Y habló Jehová con
vosotros de en medio del fuego: oisteis la voz de sus palabras, mas á
excepción de oir la voz, ninguna figura visteis: \bibverse{13} Y él os
...
\bibverse{14} A mí también me mandó Jehová entonces enseñaros los
estatutos y derechos, para que los pusieseis por obra en la tierra á la
cual pasáis para poseerla. \bibverse{15} Guardad pues mucho vuestras
almas: pues ninguna figura visteis el día que Jehová habló con vosotros
de en medio del fuego: \bibverse{16} Porque no os corrompáis, y hagáis
para vosotros escultura, imagen de figura alguna, efigie de varón ó
hembra, \bibverse{17} Figura de algún animal que sea en la tierra,
figura de ave alguna alada que vuele por el aire, \bibverse{18} Figura
de ningún animal que vaya arrastrando por la tierra, figura de pez
alguno que haya en el agua debajo de la tierra: \bibverse{19} Y porque
...
\bibverse{20} Empero á vosotros Jehová os tomó, y os ha sacado del horno
de hierro, de Egipto, para que le seáis por pueblo de heredad como en
este día. \footnote{\textbf{4:20} Éxod 19,5-6} \bibverse{21} Y Jehová se
...
heredad. \footnote{\textbf{4:21} Deut 3,26} \bibverse{22} Así que yo voy
á morir en esta tierra; y no paso el Jordán: mas vosotros pasaréis, y
poseeréis aquella buena tierra. \bibverse{23} Guardaos no os olvidéis
...
vedado. \bibverse{24} Porque Jehová tu Dios es fuego que consume, Dios
celoso.
...
\bibverse{25} Cuando hubiereis engendrado hijos y nietos, y hubiereis
...
Dios, para enojarlo; \bibverse{26} Yo pongo hoy por testigos al cielo y
...
seáis destruídos. \footnote{\textbf{4:26} Deut 30,19; Deut 31,28; Deut
  32,1} \bibverse{27} Y Jehová os esparcirá entre los pueblos, y
quedaréis pocos en número entre las gentes á las cuales os llevará
Jehová: \bibverse{28} Y serviréis allí á dioses hechos de manos de
hombres, á madera y á piedra, que no ven, ni oyen, ni comen, ni huelen.
\bibverse{29} Mas si desde allí buscares á Jehová tu Dios, lo hallarás,
si lo buscares de todo tu corazón y de toda tu alma. \footnote{\textbf{4:29}
  Sal 27,8; Jer 29,13-14} \bibverse{30} Cuando estuviereis en angustia,
...
\bibverse{31} Porque Dios misericordioso es Jehová tu Dios; no te
...
\bibverse{32} Porque pregunta ahora de los tiempos pasados, que han sido
...
gran cosa, ó se haya oído otra como ella. \bibverse{33} ¿Ha oído pueblo
la voz de Dios, que hablase de en medio del fuego, como tú la has oído,
y vivido? \footnote{\textbf{4:33} Éxod 20,1; Éxod 20,19} \bibverse{34}
...
\footnote{\textbf{4:34} Deut 7,19} \bibverse{35} A ti te fué mostrado,
para que supieses que Jehová él es Dios; no hay más fuera de él.
\footnote{\textbf{4:35} Deut 32,39} \bibverse{36} De los cielos te hizo
oir su voz, para enseñarte: y sobre la tierra te mostró su gran fuego: y
has oído sus palabras de en medio del fuego. \bibverse{37} Y por cuanto
él amó á tus padres, escogió su simiente después de ellos, y sacóte
delante de sí de Egipto con su gran poder; \bibverse{38} Para echar de
delante de ti gentes grandes y más fuertes que tú, y para introducirte,
y darte su tierra por heredad, como hoy. \bibverse{39} Aprende pues hoy,
y reduce á tu corazón que Jehová él es el Dios arriba en el cielo, y
abajo sobre la tierra; no hay otro. \bibverse{40} Y guarda sus estatutos
...
\bibverse{41} Entonces apartó Moisés tres ciudades de esta parte del
Jordán al nacimiento del sol, \footnote{\textbf{4:41} Núm 35,6-29; Deut
  19,2-13} \bibverse{42} Para que huyese allí el homicida que matase á
...
\bibverse{43} A Beser en el desierto, en tierra de la llanura, de los
...
\bibverse{44} Esta, pues, es la ley que Moisés propuso delante de los
hijos de Israel. \bibverse{45} Estos son los testimonios, y los
estatutos, y los derechos, que Moisés notificó á los hijos de Israel,
cuando hubieron salido de Egipto; \bibverse{46} De esta parte del
...
hijos de Israel, cuando hubieron salido de Egipto: \bibverse{47} Y
...
\bibverse{48} Desde Aroer, que está junto á la ribera del arroyo de
Arnón, hasta el monte de Sión, que es Hermón; \bibverse{49} Y toda la
...
\bibverse{1} Y llamó Moisés á todo Israel, y díjoles: Oye, Israel, los
estatutos y derechos que yo pronuncio hoy en vuestros oídos: y
aprendedlos, y guardadlos, para ponerlos por obra. \bibverse{2} Jehová
nuestro Dios hizo pacto con nosotros en Horeb. \footnote{\textbf{5:2}
  Deut 28,69; Éxod 19,5} \bibverse{3} No con nuestros padres hizo Jehová
este pacto, sino con nosotros todos los que estamos aquí hoy vivos.
\footnote{\textbf{5:3} Deut 29,14} \bibverse{4} Cara á cara habló Jehová
con vosotros en el monte de en medio del fuego, \footnote{\textbf{5:4}
  Deut 5,21; Éxod 19,19} \bibverse{5} (Yo estaba entonces entre Jehová y
...
\bibverse{6} Yo soy Jehová tu Dios, que te saqué de tierra de Egipto, de
casa de siervos. \footnote{\textbf{5:6} Éxod 20,-1}

\bibverse{7} No tendrás dioses extraños delante de mí. \footnote{\textbf{5:7}
  Deut 11,16; Deut 11,28}

\bibverse{8} No harás para ti escultura, ni imagen alguna de cosa que
está arriba en los cielos, ó abajo en la tierra, ó en las aguas debajo
de la tierra: \footnote{\textbf{5:8} Deut 27,15} \bibverse{9} No te
...
\bibverse{10} Y que hago misericordia á millares á los que me aman, y
guardan mis mandamientos.

\bibverse{11} No tomarás en vano el nombre de Jehová tu Dios; porque
Jehová no dará por inocente al que tomare en vano su nombre.

\bibverse{12} Guardarás el día del reposo para santificarlo, como Jehová
tu Dios te ha mandado. \bibverse{13} Seis días trabajarás y harás toda
tu obra: \bibverse{14} Mas el séptimo es reposo á Jehová tu Dios:
...
como tú. \bibverse{15} Y acuérdate que fuiste siervo en tierra de
...
\bibverse{16} Honra á tu padre y á tu madre, como Jehová tu Dios te ha
...
\bibverse{19} No hurtarás. \footnote{\textbf{5:19} Éxod 31,18}

\bibverse{20} No dirás falso testimonio contra tu prójimo.

\bibverse{21} No codiciarás la mujer de tu prójimo, ni desearás la casa
...
\bibverse{22} Estas palabras habló Jehová á toda vuestra congregación en
...
me dió á mí. \bibverse{23} Y aconteció, que como vosotros oisteis la voz
...
ancianos; \bibverse{24} Y dijisteis: He aquí, Jehová nuestro Dios nos ha
...
\bibverse{25} Ahora pues, ¿por qué moriremos? que este gran fuego nos
consumirá: si tornáremos á oir la voz de Jehová nuestro Dios, moriremos.
\bibverse{26} Porque, ¿qué es toda carne, para que oiga la voz del Dios
viviente que habla de en medio del fuego, como nosotros la oímos, y
viva? \footnote{\textbf{5:26} Deut 29,3; Núm 11,29} \bibverse{27} Llega
...
\bibverse{28} Y oyó Jehová la voz de vuestras palabras, cuando me
...
\bibverse{29} ¡Quién diera que tuviesen tal corazón, que me temiesen, y
guardasen todos los días todos mis mandamientos, para que á ellos y á
sus hijos les fuese bien para siempre!

\bibverse{30} Ve, diles: Volveos á vuestras tiendas. \bibverse{31} Y tú
...
\bibverse{32} Mirad, pues, que hagáis como Jehová vuestro Dios os ha
mandado: no os apartéis á diestra ni á siniestra; \bibverse{33} Andad en
...
\bibverse{1} Estos pues son los mandamientos, estatutos, y derechos que
Jehová vuestro Dios mandó que os enseñase, para que los pongáis por obra
en la tierra á la cual pasáis vosotros para poseerla: \bibverse{2} Para
...
los días de tu vida, y que tus días sean prolongados. \bibverse{3} Oye
...
\bibverse{4} Oye, Israel: Jehová nuestro Dios, Jehová uno es:
\footnote{\textbf{6:4} Mar 12,29; 1Cor 8,4; 1Cor 8,6} \bibverse{5} Y
amarás á Jehová tu Dios de todo tu corazón, y de toda tu alma, y con
todo tu poder. \footnote{\textbf{6:5} Deut 10,12; Mat 22,37}
\bibverse{6} Y estas palabras que yo te mando hoy, estarán sobre tu
corazón: \footnote{\textbf{6:6} Deut 11,18-20} \bibverse{7} Y las
...
por el camino, y al acostarte, y cuando te levantes: \footnote{\textbf{6:7}
  Gén 18,19} \bibverse{8} Y has de atarlas por señal en tu mano, y
estarán por frontales entre tus ojos: \footnote{\textbf{6:8} Éxod 13,9}
\bibverse{9} Y las escribirás en los postes de tu casa, y en tus
portadas.
...
\bibverse{10} Y será, cuando Jehová tu Dios te hubiere introducido en la
tierra que juró á tus padres Abraham, Isaac, y Jacob, que te daría; en
ciudades grandes y buenas que tú no edificaste, \bibverse{11} Y casas
...
hartares, \bibverse{12} Guárdate que no te olvides de Jehová, que te
sacó de tierra de Egipto, de casa de siervos. \bibverse{13} A Jehová tu
Dios temerás, y á él servirás, y por su nombre jurarás. \footnote{\textbf{6:13}
  Deut 10,20; Mat 4,10} \bibverse{14} No andaréis en pos de dioses
ajenos, de los dioses de los pueblos que están en vuestros contornos:
\bibverse{15} Porque el Dios celoso, Jehová tu Dios, en medio de ti
...
\bibverse{16} No tentaréis á Jehová vuestro Dios, como lo tentasteis en
Massa. \footnote{\textbf{6:16} Mat 4,7; Éxod 17,2; Éxod 17,7}
\bibverse{17} Guardad cuidadosamente los mandamientos de Jehová vuestro
Dios, y sus testimonios, y sus estatutos, que te ha mandado.
\bibverse{18} Y harás lo recto y bueno en ojos de Jehová, para que te
vaya bien, y entres y poseas la buena tierra que Jehová juró á tus
padres; \bibverse{19} Para que él eche á todos tus enemigos de delante
...
\bibverse{20} Cuando mañana te preguntare tu hijo, diciendo: ¿Qué
significan los testimonios, y estatutos, y derechos, que Jehová nuestro
Dios os mandó? \footnote{\textbf{6:20} Éxod 13,14} \bibverse{21}
...
\bibverse{22} Y dió Jehová señales y milagros grandes y nocivos en
Egipto, sobre Faraón y sobre toda su casa, delante de nuestros ojos;
\bibverse{23} Y sacónos de allá, para traernos y darnos la tierra que
juró á nuestros padres; \bibverse{24} Y mandónos Jehová que ejecutásemos
...
\bibverse{25} Y tendremos justicia cuando cuidáremos de poner por obra
...
\bibverse{1} Cuando Jehová tu Dios te hubiere introducido en la tierra
...
y más fuertes que tú; \footnote{\textbf{7:1} Deut 31,3} \bibverse{2} Y
...
merced. \footnote{\textbf{7:2} Núm 21,2} \bibverse{3} Y no emparentarás
con ellos: no darás tu hija á su hijo, ni tomarás á su hija para tu
hijo. \footnote{\textbf{7:3} Éxod 23,32; Éxod 34,15-16} \bibverse{4}
...
\bibverse{5} Mas así habéis de hacer con ellos: sus altares destruiréis,
y quebraréis sus estatuas, y cortaréis sus bosques, y quemaréis sus
esculturas en el fuego. \bibverse{6} Porque tú eres pueblo santo á
...
\footnote{\textbf{7:6} Éxod 19,5-6} \bibverse{7} No por ser vosotros más
...
vosotros erais los más pocos de todos los pueblos: \footnote{\textbf{7:7}
  Efes 2,8} \bibverse{8} Sino porque Jehová os amó, y quiso guardar el
...
de Egipto. \bibverse{9} Conoce, pues, que Jehová tu Dios es Dios, Dios
...
sus mandamientos, hasta las mil generaciones; \footnote{\textbf{7:9}
  Éxod 20,6} \bibverse{10} Y que da el pago en su cara al que le
aborrece, destruyéndolo: ni lo dilatará al que le odia, en su cara le
dará el pago. \bibverse{11} Guarda por tanto los mandamientos, y
...
\bibverse{12} Y será que, por haber oído estos derechos, y guardado y
...
misericordia que juró á tus padres; \footnote{\textbf{7:12} Éxod
  23,22-31} \bibverse{13} Y te amará, y te bendecirá, y te multiplicará,
...
ovejas, en la tierra que juró á tus padres que te daría. \bibverse{14}
Bendito serás más que todos los pueblos: no habrá en ti varón ni hembra
estéril, ni en tus bestias. \bibverse{15} Y quitará Jehová de ti toda
...
\bibverse{16} Y consumirás á todos los pueblos que te da Jehová tu Dios:
no los perdonará tu ojo; ni servirás á sus dioses, que te será tropiezo.
\bibverse{17} Cuando dijeres en tu corazón: Estas gentes son muchas más
que yo, ¿cómo las podré desarraigar?; \footnote{\textbf{7:17} Núm 13,31;
  Núm 14,1-4} \bibverse{18} No tengas temor de ellos: acuérdate bien de
lo que hizo Jehová tu Dios con Faraón y con todo Egipto; \bibverse{19}
...
temieres. \bibverse{20} Y también enviará Jehová tu Dios sobre ellos
...
\bibverse{21} No desmayes delante de ellos, que Jehová tu Dios está en
medio de ti, Dios grande y terrible. \bibverse{22} Y Jehová tu Dios
...
\bibverse{23} Mas Jehová tu Dios las entregará delante de ti, y él las
quebrantará con grande destrozo, hasta que sean destruídos.
\bibverse{24} Y él entregará sus reyes en tu mano, y tú destruirás el
nombre de ellos de debajo del cielo: nadie te hará frente hasta que los
destruyas. \bibverse{25} Las esculturas de sus dioses quemarás en el
...
\bibverse{26} Y no meterás abominación en tu casa, porque no seas
...
\bibverse{1} Cuidaréis de poner por obra todo mandamiento que yo os
ordeno hoy, porque viváis, y seáis multiplicados, y entréis, y poseáis
la tierra, de la cual juró Jehová á vuestros padres. \bibverse{2} Y
...
mandamientos. \footnote{\textbf{8:2} Deut 13,4; Jue 2,22} \bibverse{3} Y
...
\bibverse{4} Tu vestido nunca se envejeció sobre ti, ni el pie se te ha
hinchado por estos cuarenta años. \bibverse{5} Reconoce asimismo en tu
corazón, que como castiga el hombre á su hijo, así Jehová tu Dios te
castiga. \footnote{\textbf{8:5} Deut 1,31} \bibverse{6} Guardarás, pues,
...
\bibverse{7} Porque Jehová tu Dios te introduce en la buena tierra,
tierra de arroyos, de aguas, de fuentes, de abismos que brotan por vegas
y montes; \bibverse{8} Tierra de trigo y cebada, y de vides, é higueras,
y granados; tierra de olivas, de aceite, y de miel; \bibverse{9} Tierra
...
\bibverse{10} Y comerás y te hartarás, y bendecirás á Jehová tu Dios por
...
\bibverse{11} Guárdate, que no te olvides de Jehová tu Dios, para no
observar sus mandamientos, y sus derechos, y sus estatutos, que yo te
ordeno hoy: \bibverse{12} Que quizá no comas y te hartes, y edifiques
buenas casas en que mores, \bibverse{13} Y tus vacas y tus ovejas se
aumenten, y la plata y el oro se te multiplique, y todo lo que tuvieres
se te aumente, \bibverse{14} Y se eleve luego tu corazón, y te olvides
de Jehová tu Dios, que te sacó de tierra de Egipto, de casa de siervos;
\bibverse{15} Que te hizo caminar por un desierto grande y espantoso, de
serpientes ardientes, y de escorpiones, y de sed, donde ningún agua
había, y él te sacó agua de la roca del pedernal; \bibverse{16} Que te
...
\bibverse{17} Y digas en tu corazón: Mi poder y la fortaleza de mi mano
me han traído esta riqueza. \bibverse{18} Antes acuérdate de Jehová tu
...
\bibverse{19} Mas será, si llegares á olvidarte de Jehová tu Dios, y
...
\bibverse{20} Como las gentes que Jehová destruirá delante de vosotros,
...
\bibverse{1} Oye, Israel: tú estás hoy para pasar el Jordán, para entrar
á poseer gentes más numerosas y más fuertes que tú, ciudades grandes y
encastilladas hasta el cielo, \bibverse{2} Un pueblo grande y alto,
...
decir: ¿Quién se sostendrá delante de los hijos del gigante? \footnote{\textbf{9:2}
  Núm 13,32-33} \bibverse{3} Sabe, pues, hoy que Jehová tu Dios es el
...
\bibverse{4} No discurras en tu corazón cuando Jehová tu Dios los habrá
...
\bibverse{5} No por tu justicia, ni por la rectitud de tu corazón entras
...
juró á tus padres Abraham, Isaac, y Jacob. \bibverse{6} Por tanto, sabe
...
\bibverse{7} Acuérdate, no te olvides que has provocado á ira á Jehová
...
\bibverse{8} Y en Horeb provocasteis á ira á Jehová, y enojóse Jehová
contra vosotros para destruiros. \footnote{\textbf{9:8} Éxod 32,-1}
\bibverse{9} Cuando yo subí al monte para recibir las tablas de piedra,
...
\bibverse{10} Y dióme Jehová las dos tablas de piedra escritas con el
...
\bibverse{11} Y fué al cabo de los cuarenta días y cuarenta noches, que
Jehová me dió las dos tablas de piedra, las tablas del pacto.
\bibverse{12} Y díjome Jehová: Levántate, desciende presto de aquí; que
...
\bibverse{13} Y hablóme Jehová, diciendo: He visto ese pueblo, y he
aquí, que él es pueblo duro de cerviz: \bibverse{14} Déjame que los
destruya, y raiga su nombre de debajo del cielo; que yo te pondré sobre
gente fuerte y mucha más que ellos.

\bibverse{15} Y volví y descendí del monte, el cual ardía en fuego, con
las tablas del pacto en mis dos manos. \bibverse{16} Y miré, y he aquí
...
\bibverse{17} Entonces tomé las dos tablas, y arrojélas de mis dos
manos, y quebrélas delante de vuestros ojos. \bibverse{18} Y postréme
...
haciendo mal en ojos de Jehová para enojarlo. \bibverse{19} Porque temí
...
vosotros para destruiros. Pero Jehová me oyó aún esta vez. \footnote{\textbf{9:19}
  Heb 12,21} \bibverse{20} Contra Aarón también se enojó Jehová en gran
manera para destruirlo: y también oré por Aarón entonces. \bibverse{21}
...
\bibverse{22} También en Tabera, y en Massa, y en Kibroth-hataavah,
enojasteis á Jehová. \bibverse{23} Y cuando Jehová os envió desde
...
creisteis, ni obedecisteis á su voz. \footnote{\textbf{9:23} Núm 13,2;
  Núm 13,31; Deut 14,1-4} \bibverse{24} Rebeldes habéis sido á Jehová
...
\bibverse{26} Y oré á Jehová, diciendo: Oh Señor Jehová, no destruyas tu
pueblo y tu heredad que has redimido con tu grandeza, al cual sacaste de
Egipto con mano fuerte. \bibverse{27} Acuérdate de tus siervos Abraham,
Isaac, y Jacob; no mires á la dureza de este pueblo, ni á su impiedad,
ni á su pecado: \bibverse{28} Porque no digan los de la tierra de donde
...
\bibverse{29} Y ellos son tu pueblo y tu heredad, que sacaste con tu
gran fortaleza y con tu brazo extendido.

\hypertarget{section-9}{%
\section{10}\label{section-9}}

\bibverse{1} En aquel tiempo Jehová me dijo: Lábrate dos tablas de
piedra como las primeras, y sube á mí al monte, y hazte un arca de
madera: \bibverse{2} Y escribiré en aquellas tablas las palabras que
estaban en las tablas primeras que quebraste; y las pondrás en el arca.
\footnote{\textbf{10:2} Éxod 32,19} \bibverse{3} E hice un arca de
madera de Sittim, y labré dos tablas de piedra como las primeras, y subí
al monte con las dos tablas en mi mano. \bibverse{4} Y escribió en las
...
y diómelas Jehová. \bibverse{5} Y volví y descendí del monte, y puse las
tablas en el arca que había hecho; y allí están, como Jehová me mandó.

\bibverse{6} (Después partieron los hijos de Israel de
...
en lugar suyo tuvo el sacerdocio su hijo Eleazar. \footnote{\textbf{10:6}
  Núm 33,32-33; Núm 20,28} \bibverse{7} De allí partieron á Gudgod, y de
Gudgod á Jotbath, tierra de arroyos de aguas. \bibverse{8} En aquel
...
para bendecir en su nombre, hasta hoy. \bibverse{9} Por lo cual Leví no
tuvo parte ni heredad con sus hermanos: Jehová es su heredad, como
Jehová tu Dios le dijo.) \footnote{\textbf{10:9} Núm 18,20}

\bibverse{10} Y yo estuve en el monte como los primeros días, cuarenta
días y cuarenta noches; y Jehová me oyó también esta vez, y no quiso
Jehová destruirte. \footnote{\textbf{10:10} Deut 9,9} \bibverse{11} Y
...
\bibverse{12} Ahora pues, Israel, ¿qué pide Jehová tu Dios de ti, sino
...
\footnote{\textbf{10:12} Miq 6,8} \bibverse{13} Que guardes los
mandamientos de Jehová y sus estatutos, que yo te prescribo hoy, para
que hayas bien? \bibverse{14} He aquí, de Jehová tu Dios son los cielos,
y los cielos de los cielos: la tierra, y todas las cosas que hay en
ella. \bibverse{15} Solamente de tus padres se agradó Jehová para
amarlos, y escogió su simiente después de ellos, á vosotros, de entre
todos los pueblos, como en este día. \bibverse{16} Circuncidad pues el
prepucio de vuestro corazón, y no endurezcáis más vuestra cerviz.
\bibverse{17} Porque Jehová vuestro Dios es Dios de dioses, y Señor de
señores, Dios grande, poderoso, y terrible, que no acepta persona, ni
toma cohecho; \bibverse{18} Que hace justicia al huérfano y á la viuda;
que ama también al extranjero dándole pan y vestido. \bibverse{19}
Amaréis pues al extranjero: porque extranjeros fuisteis vosotros en
tierra de Egipto. \footnote{\textbf{10:19} Éxod 22,20-23}

\bibverse{20} A Jehová tu Dios temerás, á él servirás, á él te
allegarás, y por su nombre jurarás. \bibverse{21} El es tu alabanza, y
él es tu Dios, que ha hecho contigo estas grandes y terribles cosas que
tus ojos han visto. \bibverse{22} Con setenta almas descendieron tus
...
\bibverse{1} Amarás pues á Jehová tu Dios, y guardarás su ordenanza, y
sus estatutos y sus derechos y sus mandamientos, todos los días.
\bibverse{2} Y comprended hoy: porque no hablo con vuestros hijos que no
han sabido ni visto el castigo de Jehová vuestro Dios, su grandeza, su
mano fuerte, y su brazo extendido, \bibverse{3} Y sus señales, y sus
obras que hizo en medio de Egipto á Faraón, rey de Egipto, y á toda su
tierra; \bibverse{4} Y lo que hizo al ejército de Egipto, á sus
...
hoy; \footnote{\textbf{11:4} Éxod 14,25; Éxod 14,27} \bibverse{5} Y lo
que ha hecho con vosotros en el desierto, hasta que habéis llegado á
este lugar; \bibverse{6} Y lo que hizo con Dathán y Abiram, hijos de
...
de todo Israel: \bibverse{7} Mas vuestros ojos han visto todos los
grandes hechos que Jehová ha ejecutado.

\bibverse{8} Guardad, pues, todos los mandamientos que yo os prescribo
hoy, para que seáis esforzados, y entréis y poseáis la tierra, á la cual
pasáis para poseerla; \bibverse{9} Y para que os sean prolongados los
...
\bibverse{10} Que la tierra á la cual entras para poseerla, no es como
la tierra de Egipto de donde habéis salido, donde sembrabas tu simiente,
y regabas con tu pie, como huerto de hortaliza. \bibverse{11} La tierra
á la cual pasáis para poseerla, es tierra de montes y de vegas; de la
lluvia del cielo ha de beber las aguas; \bibverse{12} Tierra de la cual
Jehová tu Dios cuida: siempre están sobre ella los ojos de Jehová tu
Dios, desde el principio del año hasta el fin de él. \bibverse{13} Y
...
vuestro corazón, y con toda vuestra alma, \footnote{\textbf{11:13} Lev
  26,3-39} \bibverse{14} Yo daré la lluvia de vuestra tierra en su
tiempo, la temprana y la tardía; y cogerás tu grano, y tu vino, y tu
aceite. \bibverse{15} Daré también hierba en tu campo para tus bestias;
y comerás, y te hartarás. \bibverse{16} Guardaos, pues, que vuestro
corazón no se infatúe, y os apartéis, y sirváis á dioses ajenos, y os
inclinéis á ellos; \bibverse{17} Y así se encienda el furor de Jehová
...
\bibverse{18} Por tanto, pondréis estas mis palabras en vuestro corazón
...
\bibverse{19} Y las enseñaréis á vuestros hijos, hablando de ellas, ora
sentado en tu casa, ó andando por el camino, cuando te acuestes, y
cuando te levantes: \bibverse{20} Y las escribirás en los postes de tu
casa, y en tus portadas: \bibverse{21} Para que sean aumentados vuestros
...
la tierra. \bibverse{22} Porque si guardareis cuidadosamente todos estos
...
\bibverse{23} Jehová también echará todas estas gentes de delante de
vosotros y poseeréis gentes grandes y más fuertes que vosotros.
\bibverse{24} Todo lugar que pisare la planta de vuestro pie, será
vuestro: desde el desierto y el Líbano, desde el río, el río Eufrates,
hasta la mar postrera será vuestro término. \bibverse{25} Nadie se
...
dicho. \bibverse{26} He aquí yo pongo hoy delante de vosotros la
bendición y la maldición: \footnote{\textbf{11:26} Deut 30,1; Deut 30,15}
\bibverse{27} La bendición, si oyereis los mandamientos de Jehová
vuestro Dios, que yo os prescribo hoy; \footnote{\textbf{11:27} Deut
  28,2; Deut 28,15} \bibverse{28} Y la maldición, si no oyereis los
...
\bibverse{29} Y será que, cuando Jehová tu Dios te introdujere en la
...
Gerizim, y la maldición sobre el monte Ebal: \footnote{\textbf{11:29}
  Deut 27,12-13; Jos 8,33-34} \bibverse{30} Los cuales están de la otra
...
\bibverse{31} Porque vosotros pasáis el Jordán, para ir á poseer la
tierra que os da Jehová vuestro Dios; y la poseeréis, y habitaréis en
ella. \bibverse{32} Cuidaréis, pues, de poner por obra todos los
...
\bibverse{1} Estos son los estatutos y derechos que cuidaréis de poner
...
\bibverse{2} Destruiréis enteramente todos los lugares donde las gentes
...
y sobre los collados, y debajo de todo árbol espeso: \footnote{\textbf{12:2}
  Deut 7,5; Deut 7,25} \bibverse{3} Y derribaréis sus altares, y
...
ellas de aquel lugar. \bibverse{4} No haréis así á Jehová vuestro Dios.
\bibverse{5} Mas el lugar que Jehová vuestro Dios escogiere de todas
vuestras tribus, para poner allí su nombre para su habitación, ése
buscaréis, y allá iréis: \bibverse{6} Y allí llevaréis vuestros
...
\bibverse{7} Y comeréis allí delante de Jehová vuestro Dios, y os
alegraréis, vosotros y vuestras familias, en toda obra de vuestras manos
en que Jehová tu Dios te hubiere bendecido. \bibverse{8} No haréis como
todo lo que nosotros hacemos aquí ahora, cada uno lo que le parece,
\bibverse{9} Porque aun hasta ahora no habéis entrado al reposo y á la
heredad que os da Jehová vuestro Dios. \bibverse{10} Mas pasaréis el
...
habitaréis seguros. \bibverse{11} Y al lugar que Jehová vuestro Dios
...
\bibverse{12} Y os alegraréis delante de Jehová vuestro Dios, vosotros,
...
no tiene parte ni heredad con vosotros. \footnote{\textbf{12:12} Núm
  18,20; Núm 18,24} \bibverse{13} Guárdate, que no ofrezcas tus
holocaustos en cualquier lugar que vieres; \bibverse{14} Mas en el lugar
que Jehová escogiere, en una de tus tribus, allí ofrecerás tus
holocaustos, y allí harás todo lo que yo te mando.

\bibverse{15} Con todo, podrás matar y comer carne en todas tus
...
de corzo ó de ciervo: \bibverse{16} Salvo que sangre no comeréis; sobre
la tierra la derramaréis como agua. \footnote{\textbf{12:16} Lev 3,17}
\bibverse{17} Ni podrás comer en tus poblaciones el diezmo de tu grano,
...
las elevadas ofrendas de tus manos: \bibverse{18} Mas delante de Jehová
...
obra de tus manos. \bibverse{19} Ten cuidado de no desamparar al Levita
...
\bibverse{20} Cuando Jehová tu Dios ensanchare tu término, como él te ha
dicho, y tú dijeres, Comeré carne, porque deseó tu alma comerla,
conforme á todo el deseo de tu alma comerás carne. \bibverse{21} Cuando
...
todo lo que deseare tu alma. \bibverse{22} Lo mismo que se come el corzo
y el ciervo, así las comerás: el inmundo y el limpio comerán también de
ellas. \bibverse{23} Solamente que te esfuerces á no comer sangre:
porque la sangre es el alma; y no has de comer el alma juntamente con su
carne. \footnote{\textbf{12:23} Deut 12,16} \bibverse{24} No la comerás:
en tierra la derramarás como agua. \bibverse{25} No comerás de ella;
para que te vaya bien á ti, y á tus hijos después de ti, cuando hicieres
lo recto en ojos de Jehová. \bibverse{26} Empero las cosas que tuvieres
tú consagradas, y tus votos, las tomarás, y vendrás al lugar que Jehová
hubiere escogido: \bibverse{27} Y ofrecerás tus holocaustos, la carne y
...
\bibverse{28} Guarda y escucha todas estas palabras que yo te mando,
...
\bibverse{29} Cuando hubiere devastado delante de ti Jehová tu Dios las
naciones á donde tú vas para poseerlas, y las heredares, y habitares en
su tierra, \bibverse{30} Guárdate que no tropieces en pos de ellas,
...
\bibverse{31} No harás así á Jehová tu Dios; porque todo lo que Jehová
aborrece, hicieron ellos á sus dioses; pues aun á sus hijos é hijas
quemaban en el fuego á sus dioses. \bibverse{32} Cuidaréis de hacer todo
...
\bibverse{1} Cuando se levantare en medio de ti profeta, ó soñador de
sueños, y te diere señal ó prodigio, \bibverse{2} Y acaeciere la señal ó
prodigio que él te dijo, diciendo: Vamos en pos de dioses ajenos, que no
conociste, y sirvámosles; \bibverse{3} No darás oído á las palabras de
...
corazón, y con toda vuestra alma. \bibverse{4} En pos de Jehová vuestro
...
escucharéis su voz, y á él serviréis, y á él os allegaréis. \footnote{\textbf{13:4}
  Deut 8,2} \bibverse{5} Y el tal profeta ó soñador de sueños, ha de ser
...
\bibverse{6} Cuando te incitare tu hermano, hijo de tu madre, ó tu hijo,
...
padres conocisteis, \bibverse{7} De los dioses de los pueblos que están
en vuestros alrededores cercanos á ti, ó lejos de ti, desde el un cabo
de la tierra hasta el otro cabo de ella; \bibverse{8} No consentirás con
él, ni le darás oído; ni tu ojo le perdonará, ni tendrás compasión, ni
lo encubrirás: \bibverse{9} Antes has de matarlo; tu mano será primero
sobre él para matarle, y después la mano de todo el pueblo.
\bibverse{10} Y has de apedrearlo con piedras, y morirá; por cuanto
procuró apartarte de Jehová tu Dios, que te sacó de tierra de Egipto, de
casa de siervos: \footnote{\textbf{13:10} Deut 17,7} \bibverse{11} Para
...
\bibverse{12} Cuando oyeres de alguna de tus ciudades que Jehová tu Dios
te da para que mores en ellas, que se dice: \bibverse{13} Hombres, hijos
...
vosotros no conocisteis; \bibverse{14} Tú inquirirás, y buscarás, y
preguntarás con diligencia; y si pareciere verdad, cosa cierta, que tal
abominación se hizo en medio de ti, \bibverse{15} Irremisiblemente
...
\bibverse{16} Y juntarás todo el despojo de ella en medio de su plaza, y
...
\bibverse{17} Y no se pegará algo á tu mano del anatema; porque Jehová
se aparte del furor de su ira, y te dé mercedes, y tenga misericordia de
ti, y te multiplique, como lo juró á tus padres, \bibverse{18} Cuando
...
\bibverse{1} Hijos sois de Jehová vuestro Dios: no os sajaréis, ni
pondréis calva sobre vuestros ojos por muerto; \footnote{\textbf{14:1}
  Lev 19,27-28} \bibverse{2} Porque eres pueblo santo á Jehová tu Dios,
...
animales que comeréis: el buey, la oveja, y la cabra, \bibverse{5} El
ciervo, el corzo, y el búfalo, y el cabrío salvaje, y el unicornio, y
buey salvaje, y cabra montés. \bibverse{6} Y todo animal de pezuñas, que
tiene hendidura de dos uñas, y que rumiare entre los animales, ese
comeréis. \bibverse{7} Empero estos no comeréis de los que rumian, ó
tienen uña hendida: camello, y liebre, y conejo, porque rumian, mas no
tienen uña hendida, os serán inmundos; \bibverse{8} Ni puerco: porque
tiene uña hendida, mas no rumia, os será inmundo. De la carne de éstos
no comeréis, ni tocaréis sus cuerpos muertos. \bibverse{9} Esto comeréis
de todo lo que está en el agua: todo lo que tiene aleta y escama
comeréis; \bibverse{10} Mas todo lo que no tuviere aleta y escama, no
comeréis: inmundo os será. \bibverse{11} Toda ave limpia comeréis.
\bibverse{12} Y estas son de las que no comeréis: el águila, y el azor,
y el esmerejón, \bibverse{13} Y el ixio, y el buitre, y el milano según
su especie, \bibverse{14} Y todo cuervo según su especie, \bibverse{15}
Y el buho, y la lechuza, y el cuclillo, y el halcón según su especie,
\bibverse{16} Y el herodión, y el cisne, y el ibis, \bibverse{17} Y el
somormujo, y el calamón, y el corvejón, \bibverse{18} Y la cigüeña, y la
garza según su especie, y la abubilla, y el murciélago. \bibverse{19} Y
todo reptil alado os será inmundo: no se comerá. \bibverse{20} Toda ave
limpia comeréis.

\bibverse{21} Ninguna cosa mortecina comeréis: al extranjero que está en
...
\bibverse{22} Indispensablemente diezmarás todo el producto de tu
simiente, que rindiere el campo cada un año. \footnote{\textbf{14:22}
  Lev 27,30} \bibverse{23} Y comerás delante de Jehová tu Dios en el
...
días. \footnote{\textbf{14:23} Deut 12,18} \bibverse{24} Y si el camino
...
cuando Jehová tu Dios te bendijere, \bibverse{25} Entonces venderlo has,
y atarás el dinero en tu mano, y vendrás al lugar que Jehová tu Dios
escogiere; \bibverse{26} Y darás el dinero por todo lo que deseare tu
...
y te alegrarás tú y tu familia. \bibverse{27} Y no desampararás al
Levita que habitare en tus poblaciones; porque no tiene parte ni heredad
contigo. \bibverse{28} Al cabo de cada tres años sacarás todo el diezmo
de tus productos de aquel año, y lo guardarás en tus ciudades:
\footnote{\textbf{14:28} Deut 26,12-15}

\bibverse{29} Y vendrá el Levita, que no tiene parte ni heredad contigo,
...
\bibverse{1} Al cabo de siete años harás remisión. \bibverse{2} Y esta
...
\bibverse{3} Del extranjero demandarás el reintegro: mas lo que tu
hermano tuviere tuyo, lo perdonará tu mano; \bibverse{4} Para que así no
...
\bibverse{5} Si empero escuchares fielmente la voz de Jehová tu Dios,
para guardar y cumplir todos estos mandamientos que yo te intimo hoy.
\bibverse{6} Ya que Jehová tu Dios te habrá bendecido, como te ha dicho,
...
\bibverse{7} Cuando hubiere en ti menesteroso de alguno de tus hermanos
...
\footnote{\textbf{15:7} 1Jn 3,17} \bibverse{8} Mas abrirás á él tu mano
liberalmente, y en efecto le prestarás lo que basta, lo que hubiere
menester. \footnote{\textbf{15:8} Luc 6,34-35} \bibverse{9} Guárdate que
...
te imputará á pecado. \bibverse{10} Sin falta le darás, y no sea tu
corazón maligno cuando le dieres: que por ello te bendecirá Jehová tu
Dios en todos tus hechos, y en todo lo que pusieres mano. \bibverse{11}
...
\bibverse{12} Cuando se vendiere á ti tu hermano Hebreo ó Hebrea, y te
hubiere servido seis años, al séptimo año le despedirás libre de ti.
\footnote{\textbf{15:12} Éxod 21,2} \bibverse{13} Y cuando lo
despidieres libre de ti, no lo enviarás vacío: \bibverse{14} Le
abastecerás liberalmente de tus ovejas, de tu era, y de tu lagar; le
darás de aquello en que Jehová te hubiere bendecido. \bibverse{15} Y te
acordarás que fuiste siervo en la tierra de Egipto, y que Jehová tu Dios
te rescató: por tanto yo te mando esto hoy. \bibverse{16} Y será que, si
él te dijere: No saldré de contigo; porque te ama á ti y á tu casa, que
le va bien contigo; \bibverse{17} Entonces tomarás una lesna, y
horadarás su oreja junto á la puerta, y será tu siervo para siempre: así
también harás á tu criada. \bibverse{18} No te parezca duro cuando le
...
\bibverse{19} Santificarás á Jehová tu Dios todo primerizo macho que
...
vacas, ni trasquiles el primerizo de tus ovejas. \footnote{\textbf{15:19}
  Éxod 13,2} \bibverse{20} Delante de Jehová tu Dios los comerás cada un
año, tú y tu familia, en el lugar que Jehová escogiere. \footnote{\textbf{15:20}
  Deut 14,23} \bibverse{21} Y si hubiere en él tacha, ciego ó cojo, ó
cualquiera mala falta, no lo sacrificarás á Jehová tu Dios. \footnote{\textbf{15:21}
  Lev 22,20} \bibverse{22} En tus poblaciones lo comerás: el inmundo lo
mismo que el limpio comerán de él, como de un corzo ó de un ciervo.
\footnote{\textbf{15:22} Deut 12,15; Deut 12,22} \bibverse{23} Solamente
...
\bibverse{1} Guardarás el mes de Abib, y harás pascua á Jehová tu Dios:
porque en el mes de Abib te sacó Jehová tu Dios de Egipto de noche.
\footnote{\textbf{16:1} Éxod 12,-1} \bibverse{2} Y sacrificarás la
pascua á Jehová tu Dios, de las ovejas y de las vacas, en el lugar que
Jehová escogiere para hacer habitar allí su nombre. \bibverse{3} No
...
tu vida. \bibverse{4} Y no se dejará ver levadura contigo en todo tu
término por siete días; y de la carne que matares á la tarde del primer
día, no quedará hasta la mañana. \bibverse{5} No podrás sacrificar la
pascua en ninguna de tus ciudades, que Jehová tu Dios te da;
\bibverse{6} Sino en el lugar que Jehová tu Dios escogiere para hacer
habitar allí su nombre, sacrificarás la pascua por la tarde á puesta del
sol, al tiempo que saliste de Egipto: \bibverse{7} Y la asarás y comerás
en el lugar que Jehová tu Dios hubiere escogido; y por la mañana te
volverás y restituirás á tu morada. \bibverse{8} Seis días comerás
ázimos, y el séptimo día será solemnidad á Jehová tu Dios: no harás obra
en él.

\bibverse{9} Siete semanas te contarás: desde que comenzare la hoz en
las mieses comenzarás á contarte las siete semanas. \bibverse{10} Y
...
hubiere bendecido. \bibverse{11} Y te alegrarás delante de Jehová tu
...
hubiere escogido para hacer habitar allí su nombre. \footnote{\textbf{16:11}
  Deut 16,16; Éxod 20,24} \bibverse{12} Y acuérdate que fuiste siervo en
Egipto; por tanto guardarás y cumplirás estos estatutos. \footnote{\textbf{16:12}
  Deut 5,15}

\bibverse{13} La solemnidad de las cabañas harás por siete días, cuando
hubieres hecho la cosecha de tu era y de tu lagar. \bibverse{14} Y te
...
están en tus poblaciones. \footnote{\textbf{16:14} Deut 16,11; Deut
  26,11} \bibverse{15} Siete días celebrarás solemnidad á Jehová tu Dios
...
ciertamente alegre. \bibverse{16} Tres veces cada un año parecerá todo
...
\bibverse{17} Cada uno con el don de su mano, conforme á la bendición de
...
\bibverse{18} Jueces y alcaldes te pondrás en todas tus ciudades que
Jehová tu Dios te dará en tus tribus, los cuales juzgarán al pueblo con
justo juicio. \bibverse{19} No tuerzas el derecho; no hagas acepción de
...
sabios, y pervierte las palabras de los justos. \footnote{\textbf{16:19}
  Deut 1,17} \bibverse{20} La justicia, la justicia seguirás, porque
...
\bibverse{21} No te plantarás bosque de ningún árbol cerca del altar de
Jehová tu Dios, que tú te habrás hecho. \bibverse{22} Ni te levantarás
...
\bibverse{1} No sacrificarás á Jehová tu Dios buey, ó cordero, en el
...
\bibverse{2} Cuando se hallare entre ti, en alguna de tus ciudades que
...
Jehová tu Dios traspasando su pacto, \footnote{\textbf{17:2} Deut
  13,7-12} \bibverse{3} Que hubiere ido y servido á dioses ajenos, y se
...
\bibverse{4} Y te fuere dado aviso, y, después que oyeres y hubieres
indagado bien, la cosa parece de verdad cierta, que tal abominación ha
sido hecha en Israel; \bibverse{5} Entonces sacarás al hombre ó mujer
que hubiere hecho esta mala cosa, á tus puertas, hombre ó mujer, y los
apedrearás con piedras, y así morirán. \bibverse{6} Por dicho de dos
...
por el dicho de un solo testigo. \footnote{\textbf{17:6} Núm 35,30; Heb
  10,28} \bibverse{7} La mano de los testigos será primero sobre él para
...
\bibverse{8} Cuando alguna cosa te fuere oculta en juicio entre sangre y
...
que Jehová tu Dios escogiere; \bibverse{9} Y vendrás á los sacerdotes
Levitas, y al juez que fuere en aquellos días, y preguntarás; y te
enseñarán la sentencia del juicio. \bibverse{10} Y harás según la
sentencia que te indicaren los del lugar que Jehová escogiere, y
cuidarás de hacer según todo lo que te manifestaren. \bibverse{11} Según
...
mostraren. \footnote{\textbf{17:11} Deut 17,20} \bibverse{12} Y el
...
morirá: y quitarás el mal de Israel. \bibverse{13} Y todo el pueblo
oirá, y temerá, y no se ensoberbecerán más.

\hypertarget{la-ley-real}{%
\subsection{La ley real}\label{la-ley-real}}

\bibverse{14} Cuando hubieres entrado en la tierra que Jehová tu Dios te
da, y la poseyeres, y habitares en ella, y dijeres: Pondré rey sobre mí,
como todas las gentes que están en mis alrededores; \bibverse{15} Sin
...
extranjero, que no sea tu hermano. \bibverse{16} Empero que no se
...
camino. \footnote{\textbf{17:16} 1Re 10,25; 1Re 10,28} \bibverse{17} Ni
...
\bibverse{18} Y será, cuando se asentare sobre el solio de su reino, que
ha de escribir para sí en un libro un traslado de esta ley, del original
de delante de los sacerdotes Levitas; \bibverse{19} Y lo tendrá consigo,
...
estatutos, para ponerlos por obra: \bibverse{20} Para que no se eleve su
...
\bibverse{1} Los sacerdotes Levitas, toda la tribu de Leví, no tendrán
...
la heredad de él comerán. \footnote{\textbf{18:1} Deut 10,9; Núm
  18,8-20; 1Cor 9,13} \bibverse{2} No tendrán, pues, heredad entre sus
hermanos: Jehová es su heredad, como él les ha dicho. \bibverse{3} Y
...
y las quijadas, y el cuajar. \bibverse{4} Las primicias de tu grano, de
tu vino, y de tu aceite, y las primicias de la lana de tus ovejas le
darás: \bibverse{5} Porque le ha escogido Jehová tu Dios de todas tus
tribus, para que esté para ministrar al nombre de Jehová, él y sus hijos
para siempre.

\bibverse{6} Y cuando el Levita saliere de alguna de tus ciudades de
todo Israel, donde hubiere peregrinado, y viniere con todo deseo de su
alma al lugar que Jehová escogiere, \bibverse{7} Ministrará al nombre de
Jehová su Dios, como todos sus hermanos los Levitas que estuvieren allí
delante de Jehová. \bibverse{8} Porción como la porción de los otros
...
\bibverse{9} Cuando hubieres entrado en la tierra que Jehová tu Dios te
da, no aprenderás á hacer según las abominaciones de aquellas gentes.
\bibverse{10} No sea hallado en ti quien haga pasar su hijo ó su hija
...
ni hechicero, \footnote{\textbf{18:10} Lev 18,21; Lev 19,26; Lev 19,31;
  Lev 20,27} \bibverse{11} Ni fraguador de encantamentos, ni quien
pregunte á pitón, ni mágico, ni quien pregunte á los muertos.
\footnote{\textbf{18:11} 1Sam 28,11} \bibverse{12} Porque es abominación
á Jehová cualquiera que hace estas cosas, y por estas abominaciones
Jehová tu Dios las echó de delante de ti. \bibverse{13} Perfecto serás
con Jehová tu Dios. \footnote{\textbf{18:13} Gén 6,9; Sal 15,2}
\bibverse{14} Porque estas gentes que has de heredar, á agoreros y
hechiceros oían: mas tú, no así te ha dado Jehová tu Dios. \bibverse{15}
Profeta de en medio de ti, de tus hermanos, como yo, te levantará Jehová
tu Dios: á él oiréis: \bibverse{16} Conforme á todo lo que pediste á
...
\bibverse{17} Y Jehová me dijo: Bien han dicho. \footnote{\textbf{18:17}
  Deut 5,25} \bibverse{18} Profeta les suscitaré de en medio de sus
hermanos, como tú; y pondré mis palabras en su boca, y él les hablará
todo lo que yo le mandare. \bibverse{19} Mas será, que cualquiera que no
oyere mis palabras que él hablare en mi nombre, yo le residenciaré.
\bibverse{20} Empero el profeta que presumiere hablar palabra en mi
...
\bibverse{21} Y si dijeres en tu corazón: ¿Cómo conoceremos la palabra
que Jehová no hubiere hablado? \bibverse{22} Cuando el profeta hablare
...
\bibverse{1} Cuando Jehová tu Dios talare las gentes, cuya tierra Jehová
tu Dios te da á ti, y tú las heredares, y habitares en sus ciudades, y
en sus casas; \bibverse{2} Te apartarás tres ciudades en medio de tu
tierra que Jehová tu Dios te da para que la poseas. \bibverse{3}
...
homicida se huya allí. \bibverse{4} Y este es el caso del homicida que
ha de huir allí, y vivirá: el que hiriere á su prójimo por yerro, que no
le tenía enemistad desde ayer ni antes de ayer: \bibverse{5} Como el que
...
\bibverse{6} No sea que el pariente del muerto vaya tras el homicida,
...
tenía enemistad desde ayer ni antes de ayer con el muerto. \bibverse{7}
Por tanto yo te mando, diciendo: Tres ciudades te apartarás.
\bibverse{8} Y si Jehová tu Dios ensanchare tu término, como lo juró á
tus padres, y te diere toda la tierra que dijo á tus padres que había de
dar; \bibverse{9} Cuando guardases todos estos mandamientos, que yo te
...
estas tres; \bibverse{10} Porque no sea derramada sangre inocente en
medio de tu tierra, que Jehová tu Dios te da por heredad, y sea sobre ti
sangre. \bibverse{11} Mas cuando hubiere alguno que aborreciere á su
prójimo, y lo acechare, y se levantare sobre él, y lo hiriere de muerte,
y muriere, y huyere á alguna de estas ciudades; \bibverse{12} Entonces
los ancianos de su ciudad enviarán y lo sacarán de allí, y entregarlo
han en mano del pariente del muerto, y morirá. \bibverse{13} No le
...
\bibverse{14} No reducirás el término de tu prójimo, el cual señalaron
...
\bibverse{15} No valdrá un testigo contra ninguno en cualquier delito, ó
...
\footnote{\textbf{19:15} Deut 17,6; Juan 8,17; 2Cor 13,1} \bibverse{16}
Cuando se levantare testigo falso contra alguno, para testificar contra
él rebelión, \bibverse{17} Entonces los dos hombres litigantes se
...
\bibverse{18} Y los jueces inquirirán bien, y si pareciere ser aquél
testigo falso, que testificó falsamente contra su hermano, \bibverse{19}
Haréis á él como él pensó hacer á su hermano: y quitarás el mal de en
medio de ti. \bibverse{20} Y los que quedaren oirán, y temerán, y no
volverán más á hacer una mala cosa como ésta, en medio de ti.
\bibverse{21} Y no perdonará tu ojo: vida por vida, ojo por ojo, diente
...
\bibverse{1} Cuando salieres á la guerra contra tus enemigos, y vieres
...
Egipto. \bibverse{2} Y será que, cuando os acercareis para combatir,
llegaráse el sacerdote, y hablará al pueblo, \bibverse{3} Y les dirá:
...
tampoco os desalentéis delante de ellos; \bibverse{4} Que Jehová vuestro
Dios anda con vosotros, para pelear por vosotros contra vuestros
enemigos, para salvaros.

\bibverse{5} Y los oficiales hablarán al pueblo, diciendo: ¿Quién ha
...
\footnote{\textbf{20:5} Deut 16,18} \bibverse{6} ¿Y quién ha plantado
...
porque quizá no muera en la batalla, y otro alguno la goce. \footnote{\textbf{20:6}
  Deut 28,30; Lev 19,24-25} \bibverse{7} ¿Y quién se ha desposado con
...
muera en la batalla, y algún otro la tome. \footnote{\textbf{20:7} Deut
  24,5} \bibverse{8} Y tornarán los oficiales á hablar al pueblo, y
...
\footnote{\textbf{20:8} Jue 7,3} \bibverse{9} Y será que, cuando los
...
\bibverse{10} Cuando te acercares á una ciudad para combatirla, le
intimarás la paz. \footnote{\textbf{20:10} Núm 21,21-22} \bibverse{11} Y
será que, si te respondiere, Paz, y te abriere, todo el pueblo que en
ella fuere hallado te serán tributarios, y te servirán. \bibverse{12}
Mas si no hiciere paz contigo, y emprendiere contigo guerra, y la
cercares, \bibverse{13} Luego que Jehová tu Dios la entregare en tu
mano, herirás á todo varón suyo á filo de espada. \bibverse{14}
...
de tus enemigos, los cuales Jehová tu Dios te entregó. \bibverse{15} Así
harás á todas las ciudades que estuvieren muy lejos de ti, que no fueren
de las ciudades de estas gentes. \bibverse{16} Empero de las ciudades de
estos pueblos que Jehová tu Dios te da por heredad, ninguna persona
dejarás con vida; \footnote{\textbf{20:16} Jos 10,40} \bibverse{17}
...
\bibverse{18} Porque no os enseñen á hacer según todas sus
abominaciones, que ellos hacen á sus dioses, y pequéis contra Jehová
vuestro Dios. \bibverse{19} Cuando pusieres cerco á alguna ciudad,
...
\bibverse{20} Mas el árbol que supieres que no es árbol para comer, lo
...
\bibverse{1} Cuando fuere hallado en la tierra que Jehová tu Dios te da
para que la poseas, muerto echado en el campo, y no se supiere quién lo
hirió, \bibverse{2} Entonces tus ancianos y tus jueces saldrán y medirán
hasta las ciudades que están alrededor del muerto: \bibverse{3} Y será,
...
yugo; \bibverse{4} Y los ancianos de aquella ciudad traerán la becerra á
un valle áspero, que nunca haya sido arado ni sembrado, y cortarán el
pescuezo á la becerra allí en el valle. \bibverse{5} Entonces vendrán
...
ellos se determinará todo pleito y toda llaga. \footnote{\textbf{21:5}
  Deut 17,8-9} \bibverse{6} Y todos los ancianos de aquella ciudad más
cercana al muerto lavarán sus manos sobre la becerra degollada en el
valle. \footnote{\textbf{21:6} Mat 27,24} \bibverse{7} Y protestarán, y
dirán: Nuestras manos no han derramado esta sangre, ni nuestros ojos lo
vieron. \bibverse{8} Expía á tu pueblo Israel, al cual redimiste, oh
Jehová; y no imputes la sangre inocente derramada en medio de tu pueblo
Israel. Y la sangre les será perdonada. \bibverse{9} Y tú quitarás la
...
\bibverse{10} Cuando salieres á la guerra contra tus enemigos, y Jehová
tu Dios los entregare en tu mano, y tomares de ellos cautivos,
\bibverse{11} Y vieres entre los cautivos alguna mujer hermosa, y la
codiciares, y la tomares para ti por mujer, \bibverse{12} La meterás en
tu casa; y ella raerá su cabeza, y cortará sus uñas, \bibverse{13} Y se
...
tu serás su marido, y ella tu mujer. \bibverse{14} Y será, si no te
...
\bibverse{15} Cuando un hombre tuviere dos mujeres, la una amada y la
otra aborrecida, y la amada y la aborrecida le parieren hijos, y el hijo
primogénito fuere de la aborrecida; \bibverse{16} Será que, el día que
...
aborrecida, que es el primogénito; \bibverse{17} Mas al hijo de la
...
\bibverse{18} Cuando alguno tuviere hijo contumaz y rebelde, que no
obedeciere á la voz de su padre ni á la voz de su madre, y habiéndolo
castigado, no les obedeciere; \bibverse{19} Entonces tomarlo han su
padre y su madre, y lo sacarán á los ancianos de su ciudad, y á la
puerta del lugar suyo; \bibverse{20} Y dirán á los ancianos de la
ciudad: Este nuestro hijo es contumaz y rebelde, no obedece á nuestra
voz; es glotón y borracho. \bibverse{21} Entonces todos los hombres de
...
\bibverse{22} Cuando en alguno hubiere pecado de sentencia de muerte,
por el que haya de morir, y le habrás colgado en un madero,
\bibverse{23} No estará su cuerpo por la noche en el madero, mas sin
...
\bibverse{1} No verás el buey de tu hermano, ó su cordero, perdidos, y
te retirarás de ellos: precisamente los volverás á tu hermano.
\footnote{\textbf{22:1} Éxod 23,4} \bibverse{2} Y si tu hermano no fuere
...
\bibverse{3} Y así harás de su asno, así harás también de su vestido, y
lo mismo harás con toda cosa perdida de tu hermano que se le perdiere, y
tú la hallares: no podrás retraerte de ello. \bibverse{4} No verás el
...
\bibverse{5} No vestirá la mujer hábito de hombre, ni el hombre vestirá
ropa de mujer; porque abominación es á Jehová tu Dios cualquiera que
esto hace.

\bibverse{6} Cuando topares en el camino algún nido de ave en cualquier
...
hijos: \bibverse{7} Dejarás ir á la madre, y tomarás los pollos para ti;
para que te vaya bien, y prolongues tus días. \footnote{\textbf{22:7}
  Lev 22,28}

\bibverse{8} Cuando edificares casa nueva, harás pretil á tu terrado,
porque no pongas sangre en tu casa, si de él cayere alguno.

\bibverse{9} No sembrarás tu viña de varias semillas, porque no se
deprave la plenitud de la semilla que sembraste, y el fruto de la viña.
\bibverse{10} No ararás con buey y con asno juntamente. \bibverse{11} No
te vestirás de mistura, de lana y lino juntamente. \footnote{\textbf{22:11}
  Lev 19,19}

\bibverse{12} Hacerte has flecos en los cuatro cabos de tu manto con que
...
\bibverse{13} Cuando alguno tomare mujer, y después de haber entrado á
ella la aborreciere, \bibverse{14} Y le pusiere algunas faltas, y
esparciere sobre ella mala fama, y dijere: Esta tomé por mujer, y llegué
á ella, y no la hallé virgen; \bibverse{15} Entonces el padre de la moza
y su madre tomarán, y sacarán las señales de la virginidad de la
doncella á los ancianos de la ciudad, en la puerta. \bibverse{16} Y dirá
el padre de la moza á los ancianos: Yo dí mi hija á este hombre por
mujer, y él la aborrece; \bibverse{17} Y, he aquí, él le pone tachas de
...
de los ancianos de la ciudad. \bibverse{18} Entonces los ancianos de la
ciudad tomarán al hombre y lo castigarán; \bibverse{19} Y le han de
...
\bibverse{20} Mas si este negocio fué verdad, que no se hubiere hallado
virginidad en la moza, \bibverse{21} Entonces la sacarán á la puerta de
...
\bibverse{22} Cuando se sorprendiere alguno echado con mujer casada con
...
\bibverse{23} Cuando fuere moza virgen desposada con alguno, y alguno la
hallare en la ciudad, y se echare con ella; \bibverse{24} Entonces los
...
en medio de ti. \bibverse{25} Mas si el hombre halló una moza desposada
en el campo, y él la agarrare, y se echare con ella, morirá sólo el
hombre que con ella se habrá echado; \bibverse{26} Y á la moza no harás
...
\bibverse{27} Porque él la halló en el campo: dió voces la moza
desposada, y no hubo quien la valiese. \bibverse{28} Cuando alguno
hallare moza virgen, que no fuere desposada, y la tomare, y se echare
con ella, y fueren hallados; \bibverse{29} Entonces el hombre que se
...
días. \bibverse{30} No tomará alguno la mujer de su padre, ni descubrirá
...
\bibverse{1} No entrará en la congregación de Jehová el que fuere
quebrado, ni el castrado. \footnote{\textbf{23:1} Lev 18,8} \bibverse{2}
No entrará bastardo en la congregación de Jehová: ni aun en la décima
generación entrará en la congregación de Jehová. \bibverse{3} No entrará
...
\bibverse{4} Por cuanto no os salieron á recibir con pan y agua al
...
\bibverse{5} Mas no quiso Jehová tu Dios oir á Balaam; y Jehová tu Dios
te volvió la maldición en bendición, porque Jehová tu Dios te amaba.
\bibverse{6} No procurarás la paz de ellos ni su bien en todos los días
para siempre. \bibverse{7} No abominarás al Idumeo, que tu hermano es:
no abominarás al Egipcio, que extranjero fuiste en su tierra.
\bibverse{8} Los hijos que nacieren de ellos, á la tercera generación
...
\bibverse{9} Cuando salieres á campaña contra tus enemigos, guárdate de
toda cosa mala. \bibverse{10} Cuando hubiere en ti alguno que no fuere
limpio por accidente de noche, saldráse del campo, y no entrará en él.
\bibverse{11} Y será que al declinar de la tarde se lavará con agua, y
cuando fuere puesto el sol, entrará en el campo. \bibverse{12} Y tendrás
un lugar fuera del real, y saldrás allá fuera; \bibverse{13} Tendrás
...
\bibverse{14} Porque Jehová tu Dios anda por medio de tu campo, para
...
\bibverse{15} No entregarás á su señor el siervo que se huyere á ti de
su amo: \footnote{\textbf{23:15} Lev 26,12} \bibverse{16} More contigo,
en medio de ti, en el lugar que escogiere en alguna de tus ciudades,
donde bien le estuviere: no le harás fuerza.

\bibverse{17} No habrá ramera de las hijas de Israel, ni habrá
sodomítico de los hijos de Israel. \bibverse{18} No traerás precio de
...
\bibverse{19} No tomarás de tu hermano logro de dinero, ni logro de
comida, ni logro de cosa alguna de que se suele tomar. \footnote{\textbf{23:19}
  Lev 18,22; Apoc 22,15} \bibverse{20} Del extraño tomarás logro, mas de
...
\bibverse{21} Cuando prometieres voto á Jehová tu Dios, no tardarás en
pagarlo; porque ciertamente lo demandará Jehová tu Dios de ti, y habría
en ti pecado. \bibverse{22} Mas cuando te abstuvieres de prometer, no
habrá en ti pecado. \bibverse{23} Guardarás lo que tus labios
pronunciaren; y harás, como prometiste á Jehová tu Dios, lo que de tu
voluntad hablaste por tu boca. \bibverse{24} Cuando entrares en la viña
de tu prójimo, comerás uvas hasta saciar tu deseo: mas no pondrás en tu
vaso. \bibverse{25} Cuando entrares en la mies de tu prójimo, podrás
...
\bibverse{1} Cuando alguno tomare mujer y se casare con ella, si no le
...
\footnote{\textbf{24:1} Mat 5,31-32; Mat 19,7} \bibverse{2} Y salida de
su casa, podrá ir y casarse con otro hombre. \bibverse{3} Y si la
...
postrer hombre que la tomó para sí por mujer, \bibverse{4} No podrá su
...
\bibverse{5} Cuando tomare alguno mujer nueva, no saldrá á la guerra, ni
...
\bibverse{6} No tomarás en prenda la muela de molino, ni la de abajo ni
la de arriba: porque sería prendar la vida.

\bibverse{7} Cuando fuere hallado alguno que haya hurtado persona de sus
...
\bibverse{8} Guárdate de llaga de lepra, observando diligentemente, y
...
cuidaréis de hacer como les he mandado. \footnote{\textbf{24:8} Lev
  13,-1; Lev 14,2} \bibverse{9} Acuérdate de lo que hizo Jehová tu Dios
á María en el camino, después que salisteis de Egipto. \footnote{\textbf{24:9}
  Núm 12,10-15}

\bibverse{10} Cuando dieres á tu prójimo alguna cosa emprestada, no
entrarás en su casa para tomarle prenda: \bibverse{11} Fuera estarás, y
el hombre á quien prestaste, te sacará afuera la prenda. \bibverse{12} Y
si fuere hombre pobre, no duermas con su prenda: \bibverse{13}
...
\bibverse{14} No hagas agravio al jornalero pobre y menesteroso, así de
tus hermanos como de tus extranjeros que están en tu tierra en tus
ciudades: \footnote{\textbf{24:14} Lev 19,13} \bibverse{15} En su día le
...
\bibverse{16} Los padres no morirán por los hijos, ni los hijos por los
padres; cada uno morirá por su pecado. \footnote{\textbf{24:16} 2Re
  14,6; Ezeq 18,19-20}

\bibverse{17} No torcerás el derecho del peregrino y del huérfano; ni
tomarás por prenda la ropa de la viuda: \footnote{\textbf{24:17} Éxod
  22,20-21} \bibverse{18} Mas acuérdate que fuiste siervo en Egipto, y
de allí te rescató Jehová tu Dios: por tanto, yo te mando que hagas
esto. \footnote{\textbf{24:18} Deut 16,12}

\bibverse{19} Cuando segares tu mies en tu campo, y olvidares alguna
...
obra de tus manos. \footnote{\textbf{24:19} Lev 19,9-10} \bibverse{20}
Cuando sacudieres tus olivas, no recorrerás las ramas tras ti: para el
extranjero, para el huérfano, y para la viuda será.

\bibverse{21} Cuando vendimiares tu viña, no rebuscarás tras ti: para el
extranjero, para el huérfano, y para la viuda será. \bibverse{22} Y
...
\bibverse{1} Cuando hubiere pleito entre algunos, y vinieren á juicio, y
los juzgaren, y absolvieren al justo y condenaren al inicuo,
\bibverse{2} Será que, si el delincuente mereciere ser azotado, entonces
el juez lo hará echar en tierra, y harále azotar delante de sí, según su
delito, por cuenta. \bibverse{3} Harále dar cuarenta azotes, no más: no
...
\bibverse{4} No pondrás bozal al buey cuando trillare. \footnote{\textbf{25:4}
  1Cor 9,9; 1Tim 5,18}
...
\bibverse{5} Cuando hermanos estuvieren juntos, y muriere alguno de
...
\bibverse{6} Y será que el primogénito que pariere ella, se levantará en
nombre de su hermano el muerto, porque el nombre de éste no sea raído de
Israel.

\bibverse{7} Y si el hombre no quisiere tomar á su cuñada, irá entonces
...
\bibverse{8} Entonces los ancianos de aquella ciudad lo harán venir, y
hablarán con él: y si él se levantare, y dijere, No quiero tomarla,
\bibverse{9} Llegaráse entonces su cuñada á él delante de los ancianos,
...
hermano. \bibverse{10} Y su nombre será llamado en Israel: La casa del
descalzado.
...
\bibverse{11} Cuando algunos riñeren juntos el uno con el otro, y
llegare la mujer del uno para librar á su marido de mano del que le
hiriere, y metiere su mano y le trabare de sus vergüenzas; \bibverse{12}
La cortarás entonces la mano, no la perdonará tu ojo.

\bibverse{13} No tendrás en tu bolsa pesa grande y pesa chica.
\bibverse{14} No tendrás en tu casa epha grande y epha pequeño.
\bibverse{15} Pesas cumplidas y justas tendrás; epha cabal y justo
tendrás: para que tus días sean prolongados sobre la tierra que Jehová
tu Dios te da. \bibverse{16} Porque abominación es á Jehová tu Dios
...
\bibverse{17} Acuérdate de lo que te hizo Amalec en el camino, cuando
salisteis de Egipto: \footnote{\textbf{25:17} Éxod 17,8-16}

\bibverse{18} Que te salió al camino, y te desbarató la retaguardia de
todos los flacos que iban detrás de ti, cuando tú estabas cansado y
trabajado; y no temió á Dios. \bibverse{19} Será pues, cuando Jehová tu
...
\bibverse{1} Y será que, cuando hubieres entrado en la tierra que Jehová
tu Dios te da por heredad, y la poseyeres, y habitares en ella;
\bibverse{2} Entonces tomarás de las primicias de todos los frutos de la
...
hacer habitar allí su nombre. \footnote{\textbf{26:2} Éxod 23,19; Éxod
  34,26; Lev 2,14} \bibverse{3} Y llegarás al sacerdote que fuere en
...
\bibverse{4} Y el sacerdote tomará el canastillo de tu mano, y pondrálo
delante del altar de Jehová tu Dios. \bibverse{5} Entonces hablarás y
...
allí creció en gente grande, fuerte y numerosa: \bibverse{6} Y los
Egipcios nos maltrataron, y nos afligieron, y pusieron sobre nosotros
dura servidumbre. \bibverse{7} Y clamamos á Jehová Dios de nuestros
padres; y oyó Jehová nuestra voz, y vió nuestra aflicción, y nuestro
trabajo, y nuestra opresión: \bibverse{8} Y sacónos Jehová de Egipto con
mano fuerte, y con brazo extendido, y con grande espanto, y con señales
y con milagros: \bibverse{9} Y trájonos á este lugar, y diónos esta
tierra, tierra que fluye leche y miel. \bibverse{10} Y ahora, he aquí,
...
Jehová tu Dios. \bibverse{11} Y te alegrarás con todo el bien que Jehová
...
\bibverse{12} Cuando hubieres acabado de diezmar todo el diezmo de tus
...
saciarán. \footnote{\textbf{26:12} Deut 14,27-29} \bibverse{13} Y dirás
...
traspasado tus mandamientos, ni me he olvidado de ellos: \bibverse{14}
...
he hecho conforme á todo lo que me has mandado. \bibverse{15} Mira desde
...
\bibverse{16} Jehová tu Dios te manda hoy que cumplas estos estatutos y
derechos; cuida, pues, de ponerlos por obra con todo tu corazón, y con
toda tu alma. \bibverse{17} A Jehová has ensalzado hoy para que te sea
por Dios, y para andar en sus caminos, y para guardar sus estatutos y
sus mandamientos y sus derechos, y para oir su voz: \bibverse{18} Y
Jehová te ha ensalzado hoy para que le seas su peculiar pueblo, como él
te lo ha dicho, y para que guardes todos sus mandamientos; \bibverse{19}
...
\bibverse{1} Y mandó Moisés, con los ancianos de Israel, al pueblo,
diciendo: Guardaréis todos los mandamientos que yo prescribo hoy.
\bibverse{2} Y será que, el día que pasareis el Jordán á la tierra que
Jehová tu Dios te da, te has de levantar piedras grandes, las cuales
revocarás con cal: \bibverse{3} Y escribirás en ellas todas las palabras
...
padres te ha dicho. \bibverse{4} Será pues, cuando hubieres pasado el
Jordán, que levantaréis estas piedras que yo os mando hoy, en el monte
de Ebal, y las revocarás con cal: \bibverse{5} Y edificarás allí altar á
Jehová tu Dios, altar de piedras: no alzarás sobre ellas hierro.
\bibverse{6} De piedras enteras edificarás el altar de Jehová tu Dios; y
ofrecerás sobre él holocausto á Jehová tu Dios; \bibverse{7} Y
sacrificarás pacíficos, y comerás allí; y alegrarte has delante de
Jehová tu Dios. \footnote{\textbf{27:7} Deut 12,7} \bibverse{8} Y
...
\bibverse{9} Y Moisés, con los sacerdotes Levitas, habló á todo Israel,
diciendo: Atiende y escucha, Israel: hoy eres hecho pueblo de Jehová tu
Dios. \bibverse{10} Oirás pues la voz de Jehová tu Dios, y cumplirás sus
mandamientos y sus estatutos, que yo te ordeno hoy.

\bibverse{11} Y mandó Moisés al pueblo en aquel día, diciendo:
\bibverse{12} Estos estarán sobre el monte de Gerizim para bendecir al
...
\bibverse{13} Y estos estarán para pronunciar la maldición en el de
Ebal: Rubén, Gad, y Aser, y Zabulón, Dan, y Nephtalí. \bibverse{14} Y
...
\bibverse{15} Maldito el hombre que hiciere escultura ó imagen de
fundición, abominación á Jehová, obra de mano de artífice, y la pusiere
en oculto. Y todo el pueblo responderá y dirá: Amén.

\bibverse{16} Maldito el que deshonrare á su padre ó á su madre. Y dirá
todo el pueblo: Amén. \footnote{\textbf{27:16} Éxod 21,17}

\bibverse{17} Maldito el que redujere el término de su prójimo. Y dirá
todo el pueblo: Amén. \footnote{\textbf{27:17} Deut 19,14}

\bibverse{18} Maldito el que hiciere errar al ciego en el camino. Y dirá
todo el pueblo: Amén. \footnote{\textbf{27:18} Lev 19,14}

\bibverse{19} Maldito el que torciere el derecho del extranjero, del
huérfano, y de la viuda. Y dirá todo el pueblo: Amén. \footnote{\textbf{27:19}
  Éxod 22,20-21}

\bibverse{20} Maldito el que se echare con la mujer de su padre; por
cuanto descubrió el regazo de su padre. Y dirá todo el pueblo: Amén.
\footnote{\textbf{27:20} Lev 18,8}

\bibverse{21} Maldito el que tuviere parte con cualquiera bestia. Y dirá
todo el pueblo: Amén. \footnote{\textbf{27:21} Éxod 22,18}

\bibverse{22} Maldito el que se echare con su hermana, hija de su padre,
ó hija de su madre. Y dirá todo el pueblo: Amén. \footnote{\textbf{27:22}
  Lev 18,9; Lev 18,11}

\bibverse{23} Maldito el que se echare con su suegra. Y dirá todo el
pueblo: Amén. \footnote{\textbf{27:23} Lev 18,17}

\bibverse{24} Maldito el que hiriere á su prójimo ocultamente. Y dirá
todo el pueblo: Amén. \footnote{\textbf{27:24} Núm 35,20}

\bibverse{25} Maldito el que recibiere don para herir de muerte al
inocente. Y dirá todo el pueblo: Amén. \footnote{\textbf{27:25} Deut
  16,19; Éxod 23,8}

\bibverse{26} Maldito el que no confirmare las palabras de esta ley para
...
\bibverse{1} Y será que, si oyeres diligente la voz de Jehová tu Dios,
...
gentes de la tierra; \footnote{\textbf{28:1} Deut 26,19} \bibverse{2} Y
vendrán sobre ti todas estas bendiciones, y te alcanzarán, cuando oyeres
la voz de Jehová tu Dios. \bibverse{3} Bendito serás tú en la ciudad, y
bendito tú en el campo. \bibverse{4} Bendito el fruto de tu vientre, y
el fruto de tu bestia, la cría de tus vacas, y los rebaños de tus
ovejas. \bibverse{5} Bendito tu canastillo y tus sobras. \bibverse{6}
Bendito serás en tu entrar, y bendito en tu salir. \footnote{\textbf{28:6}
  Sal 121,8} \bibverse{7} Pondrá Jehová á tus enemigos que se levantaren
contra ti, de rota batida delante de ti: por un camino saldrán á ti, por
siete caminos huirán delante de ti. \bibverse{8} Enviará Jehová contigo
la bendición en tus graneros, y en todo aquello en que pusieres tu mano;
y te bendecirá en la tierra que Jehová tu Dios te da. \bibverse{9}
...
caminos. \footnote{\textbf{28:9} Éxod 19,5-6} \bibverse{10} Y verán
todos los pueblos de la tierra que el nombre de Jehová es llamado sobre
ti, y te temerán. \bibverse{11} Y te hará Jehová sobreabundar en bienes,
...
\bibverse{12} Abrirte ha Jehová su buen depósito, el cielo, para dar
lluvia á tu tierra en su tiempo, y para bendecir toda obra de tus manos.
Y prestarás á muchas gentes, y tú no tomarás emprestado. \bibverse{13} Y
...
\bibverse{14} Y no te apartes de todas las palabras que yo os mando hoy,
...
\bibverse{15} Y será, si no oyeres la voz de Jehová tu Dios, para cuidar
...
alcanzarán. \footnote{\textbf{28:15} Dan 9,11} \bibverse{16} Maldito
serás tu en la ciudad, y maldito en el campo. \bibverse{17} Maldito tu
canastillo, y tus sobras. \bibverse{18} Maldito el fruto de tu vientre,
y el fruto de tu tierra, y la cría de tus vacas, y los rebaños de tus
ovejas. \bibverse{19} Maldito serás en tu entrar, y maldito en tu salir.
\bibverse{20} Y Jehová enviará contra ti la maldición, quebranto y
...
cuales me habrás dejado. \bibverse{21} Jehová hará que se te pegue
mortandad, hasta que te consuma de la tierra á la cual entras para
poseerla. \bibverse{22} Jehová te herirá de tisis, y de fiebre, y de
...
añublo; y perseguirte han hasta que perezcas. \footnote{\textbf{28:22}
  1Re 17,7} \bibverse{23} Y tus cielos que están sobre tu cabeza, serán
de metal; y la tierra que está debajo de ti, de hierro. \footnote{\textbf{28:23}
  Deut 11,17} \bibverse{24} Dará Jehová por lluvia á tu tierra polvo y
ceniza: de los cielos descenderán sobre ti hasta que perezcas.
\bibverse{25} Jehová te entregará herido delante de tus enemigos: por un
camino saldrás á ellos, y por siete caminos huirás delante de ellos: y
serás sacudido á todos los reinos de la tierra. \bibverse{26} Y será tu
cuerpo muerto por comida á toda ave del cielo y bestia de la tierra, y
no habrá quien las espante. \bibverse{27} Jehová te herirá de la plaga
de Egipto, y con almorranas, y con sarna, y con comezón, de que no
puedas ser curado. \footnote{\textbf{28:27} Éxod 9,9} \bibverse{28}
Jehová te herirá con locura, y con ceguedad, y con pasmo de corazón.
\bibverse{29} Y palparás al mediodía, como palpa el ciego en la
...
\bibverse{30} Te desposarás con mujer, y otro varón dormirá con ella;
edificarás casa, y no habitarás en ella; plantarás viña, y no la
vendimiarás. \bibverse{31} Tu buey será matado delante de tus ojos, y tú
...
las rescate. \bibverse{32} Tus hijos y tus hijas serán entregados á otro
pueblo, y tus ojos lo verán, y desfallecerán por ellos todo el día: y no
habrá fuerza en tu mano. \bibverse{33} El fruto de tu tierra y todo tu
...
\bibverse{34} Y enloquecerás á causa de lo que verás con tus ojos.
\bibverse{35} Herirte ha Jehová con maligna pústula en las rodillas y en
las piernas, sin que puedas ser curado: aun desde la planta de tu pie
hasta tu mollera. \bibverse{36} Jehová llevará á ti, y á tu rey que
hubieres puesto sobre ti, á gente que no conociste tú ni tus padres; y
allá servirás á dioses ajenos, al palo y á la piedra. \bibverse{37} Y
serás por pasmo, por ejemplo y por fábula, á todos los pueblos á los
cuales te llevará Jehová. \footnote{\textbf{28:37} 1Re 9,7}
\bibverse{38} Sacarás mucha simiente al campo, y cogerás poco; porque la
langosta lo consumirá. \footnote{\textbf{28:38} Jer 12,13; Miq 6,15}
\bibverse{39} Plantarás viñas y labrarás, mas no beberás vino, ni
cogerás uvas; porque el gusano las comerá. \bibverse{40} Tendrás olivas
en todo tu término, mas no te ungirás con el aceite; porque tu aceituna
se caerá. \bibverse{41} Hijos é hijas engendrarás, y no serán para ti;
porque irán en cautiverio. \bibverse{42} Toda tu arboleda y el fruto de
tu tierra consumirá la langosta. \bibverse{43} El extranjero que estará
en medio de ti subirá sobre ti muy alto, y tú serás puesto muy bajo.
\bibverse{44} El te prestará á ti, y tú no prestarás á él: él será por
cabeza, y tú serás por cola. \footnote{\textbf{28:44} Deut 28,12-13}

\bibverse{45} Y vendrán sobre ti todas estas maldiciones, y te
...
estatutos, que él te mandó: \bibverse{46} Y serán en ti por señal y por
...
\bibverse{47} Por cuanto no serviste á Jehová tu Dios con alegría y con
gozo de corazón, por la abundancia de todas las cosas; \bibverse{48}
...
pondrá yugo de hierro sobre tu cuello, hasta destruirte. \bibverse{49}
Jehová traerá sobre ti gente de lejos, del cabo de la tierra, que vuele
como águila, gente cuya lengua no entiendas; \bibverse{50} Gente fiera
de rostro, que no tendrá respeto al anciano, ni perdonará al niño:
\footnote{\textbf{28:50} Dan 8,23; Lam 5,12} \bibverse{51} Y comerá el
...
rebaños de tus ovejas, hasta destruirte. \bibverse{52} Y te pondrá cerco
...
\bibverse{53} Y comerás el fruto de tu vientre, la carne de tus hijos y
de tus hijas que Jehová tu Dios te dió, en el cerco y en el apuro con
que te angustiará tu enemigo. \bibverse{54} El hombre tierno en ti, y el
...
\bibverse{55} Para no dar á alguno de ellos de la carne de sus hijos,
que él comerá, porque nada le habrá quedado, en el cerco y en el apuro
con que tu enemigo te oprimirá en todas tus ciudades. \bibverse{56} La
...
\bibverse{57} Y para con su chiquita que sale de entre sus pies, y para
...
ciudades. \bibverse{58} Si no cuidares de poner por obra todas las
palabras de aquesta ley que están escritas en este libro, temiendo este
nombre glorioso y terrible, JEHOVÁ TU DIOS, \bibverse{59} Jehová
...
\bibverse{60} Y hará volver sobre ti todos los males de Egipto, delante
de los cuales temiste, y se te pegarán. \footnote{\textbf{28:60} Deut
  28,27} \bibverse{61} Asimismo toda enfermedad y toda plaga que no está
escrita en el libro de esta ley, Jehová la enviará sobre ti, hasta que
tú seas destruído. \bibverse{62} Y quedaréis en poca gente, en lugar de
haber sido como las estrellas del cielo en multitud; por cuanto no
obedeciste á la voz de Jehová tu Dios. \bibverse{63} Y será que como
...
\bibverse{64} Y Jehová te esparcirá por todos los pueblos, desde el un
...
\bibverse{65} Y ni aun entre las mismas gentes descansarás, ni la planta
de tu pie tendrá reposo; que allí te dará Jehová corazón temeroso, y
caimiento de ojos, y tristeza de alma: \bibverse{66} Y tendrás tu vida
como colgada delante de ti, y estarás temeroso de noche y de día, y no
confiarás de tu vida. \bibverse{67} Por la mañana dirás: ¡Quién diera
...
ojos. \bibverse{68} Y Jehová te hará tornar á Egipto en navíos por el
...
\bibverse{1} Estas son las palabras del pacto que Jehová mandó á Moisés
...
\bibverse{2} Moisés pues llamó á todo Israel, y díjoles: Vosotros habéis
...
\bibverse{3} Las pruebas grandes que vieron tus ojos, las señales, y las
grandes maravillas. \footnote{\textbf{29:3} Deut 5,26; Is 6,9-10}
\bibverse{4} Y Jehová no os dió corazón para entender, ni ojos para ver,
ni oídos para oir, hasta el día de hoy. \footnote{\textbf{29:4} Deut
  8,2; Deut 8,4} \bibverse{5} Y yo os he traído cuarenta años por el
desierto: vuestros vestidos no se han envejecido sobre vosotros, ni tu
zapato se ha envejecido sobre tu pie. \bibverse{6} No habéis comido pan,
ni bebisteis vino ni sidra: para que supieseis que yo soy Jehová vuestro
Dios. \footnote{\textbf{29:6} Núm 21,21-35} \bibverse{7} Y llegasteis á
...
\bibverse{8} Y tomamos su tierra, y dímosla por heredad á Rubén y á Gad,
y á la media tribu de Manasés. \bibverse{9} Guardaréis, pues, las
...
\bibverse{10} Vosotros todos estáis hoy delante de Jehová vuestro Dios;
vuestros príncipes de vuestras tribus, vuestros ancianos, y vuestros
oficiales, todos los varones de Israel, \bibverse{11} Vuestros niños,
vuestras mujeres, y tus extranjeros que habitan en medio de tu campo,
desde el que corta tu leña hasta el que saca tus aguas: \bibverse{12}
Para que entres en el pacto de Jehová tu Dios, y en su juramento, que
Jehová tu Dios acuerda hoy contigo: \bibverse{13} Para confirmarte hoy
...
dicho, y como él juró á tus padres Abraham, Isaac, y Jacob. \footnote{\textbf{29:13}
  Deut 5,3} \bibverse{14} Y no con vosotros solos acuerdo yo este pacto
y este juramento, \bibverse{15} Sino con los que están aquí presentes
...
\bibverse{16} Porque vosotros sabéis cómo habitamos en la tierra de
Egipto, y cómo hemos pasado por medio de las gentes que habéis pasado;
\bibverse{17} Y habéis visto sus abominaciones, y sus ídolos, madera y
piedra, plata y oro, que tienen consigo. \bibverse{18} Quizá habrá entre
...
\bibverse{19} Y sea que, cuando el tal oyere las palabras de esta
...
sed: \footnote{\textbf{29:19} Deut 18,15-68} \bibverse{20} Jehová no
...
este libro, y Jehová raerá su nombre de debajo del cielo: \bibverse{21}
...
\bibverse{22} Y dirá la generación venidera, vuestros hijos que vendrán
...
Jehová la hizo enfermar, \bibverse{23} (Azufre y sal, abrasada toda su
...
\bibverse{1} Y será que, cuando te sobrevinieren todas estas cosas, la
...
hubiere echado, \bibverse{2} Y te convirtieres á Jehová tu Dios, y
...
hijos, con todo tu corazón y con toda tu alma, \footnote{\textbf{30:2}
  Lev 26,40} \bibverse{3} Jehová también volverá tus cautivos, y tendrá
...
cuales te hubiere esparcido Jehová tu Dios. \footnote{\textbf{30:3} Jer
  29,14; Am 9,14; Jer 32,37} \bibverse{4} Si hubieres sido arrojado
hasta el cabo de los cielos, de allí te recogerá Jehová tu Dios, y de
allá te tomará: \bibverse{5} Y volverte ha Jehová tu Dios á la tierra
que heredaron tus padres, y la poseerás; y te hará bien, y te
multiplicará más que á tus padres. \bibverse{6} Y circuncidará Jehová tu
...
\footnote{\textbf{30:6} Deut 10,16; Jer 4,4; Ezeq 11,19; Rom 2,29; Col
  2,11} \bibverse{7} Y pondrá Jehová tu Dios todas estas maldiciones
sobre tus enemigos, y sobre tus aborrecedores que te persiguieron.
\bibverse{8} Y tú volverás, y oirás la voz de Jehová, y pondrás por obra
todos sus mandamientos, que yo te intimo hoy. \bibverse{9} Y hacerte ha
...
que se gozó sobre tus padres; \bibverse{10} Cuando oyeres la voz de
...
\bibverse{11} Porque este mandamiento que yo te intimo hoy, no te es
encubierto, ni está lejos: \bibverse{12} No está en el cielo, para que
digas: ¿Quién subirá por nosotros al cielo, y nos lo traerá y nos lo
representará, para que lo cumplamos? \bibverse{13} Ni está de la otra
...
\bibverse{14} Porque muy cerca de ti está la palabra, en tu boca y en tu
...
\bibverse{15} Mira, yo he puesto delante de ti hoy la vida y el bien, la
muerte y el mal: \footnote{\textbf{30:15} Deut 11,26; Deut 28,2; Deut
  2,15} \bibverse{16} Porque yo te mando hoy que ames á Jehová tu Dios,
...
bendiga en la tierra á la cual entras para poseerla. \bibverse{17} Mas
si tu corazón se apartare, y no oyeres, y fueres incitado, y te
inclinares á dioses ajenos, y los sirvieres; \bibverse{18} Protéstoos
hoy que de cierto pereceréis: no tendréis largos días sobre la tierra,
para ir á la cual pasas el Jordán para poseerla. \bibverse{19} A los
...
\bibverse{20} Que ames á Jehová tu Dios, que oigas su voz, y te allegues
...
\bibverse{1} Y fué Moisés, y habló estas palabras á todo Israel,
\bibverse{2} Y díjoles: De edad de ciento y veinte años soy hoy día; no
puedo más salir ni entrar: á más de esto Jehová me ha dicho: No pasarás
este Jordán. \bibverse{3} Jehová tu Dios, él pasa delante de ti; él
...
que pasará delante de ti, como Jehová ha dicho. \footnote{\textbf{31:3}
  Deut 3,28} \bibverse{4} Y hará Jehová con ellos como hizo con Sehón y
con Og, reyes de los Amorrheos, y con su tierra, que los destruyó.
\footnote{\textbf{31:4} Núm 21,21-35} \bibverse{5} Y los entregará
Jehová delante de vosotros, y haréis con ellos conforme á todo lo que os
he mandado. \footnote{\textbf{31:5} Deut 7,2} \bibverse{6} Esforzaos y
cobrad ánimo; no temáis, ni tengáis miedo de ellos: que Jehová tu Dios
es el que va contigo: no te dejará ni te desamparará.

\bibverse{7} Y llamó Moisés á Josué, y díjole á vista de todo Israel:
...
\bibverse{8} Y Jehová es el que va delante de ti; él será contigo, no te
...
\bibverse{9} Y escribió Moisés esta ley, y dióla á los sacerdotes, hijos
de Leví, que llevaban el arca del pacto de Jehová, y á todos los
ancianos de Israel. \bibverse{10} Y mandóles Moisés, diciendo: Al cabo
del séptimo año, en el año de la remisión, en la fiesta de las Cabañas,
\footnote{\textbf{31:10} Deut 15,1} \bibverse{11} Cuando viniere todo
...
\bibverse{12} Harás congregar el pueblo, varones y mujeres y niños, y
...
todas las palabras de esta ley: \bibverse{13} Y los hijos de ellos que
...
\bibverse{14} Y Jehová dijo á Moisés: He aquí se han acercado tus días
...
\bibverse{15} Y aparecióse Jehová en el tabernáculo, en la columna de
nube; y la columna de nube se puso sobre la puerta del tabernáculo.
\bibverse{16} Y Jehová dijo á Moisés: He aquí tú vas á dormir con tus
...
invalidará mi pacto que he concertado con él: \bibverse{17} Y mi furor
...
está mi Dios en medio de mí? \bibverse{18} Empero yo esconderé
...
\bibverse{19} Ahora pues, escribíos este cántico, y enséñalo á los hijos
...
\bibverse{20} Porque yo le introduciré en la tierra que juré á sus
...
\bibverse{21} Y será que cuando le vinieren muchos males y angustias,
...
\bibverse{22} Y Moisés escribió este cántico aquel día, y enseñólo á los
hijos de Israel.

\bibverse{23} Y dió orden á Josué hijo de Nun, y dijo: Esfuérzate y
...
\bibverse{24} Y como acabó Moisés de escribir las palabras de esta ley
en un libro hasta concluirse, \bibverse{25} Mandó Moisés á los Levitas
que llevaban el arca del pacto de Jehová, diciendo: \bibverse{26} Tomad
este libro de la ley, y ponedlo al lado del arca del pacto de Jehová
vuestro Dios, y esté allí por testigo contra ti. \bibverse{27} Porque yo
...
muerto? \bibverse{28} Congregad á mí todos los ancianos de vuestras
tribus, y á vuestros oficiales, y hablaré en sus oídos estas palabras, y
llamaré por testigos contra ellos los cielos y la tierra. \bibverse{29}
...
\bibverse{30} Entonces habló Moisés en oídos de toda la congregación de
...
\bibverse{1} Escuchad, cielos, y hablaré; y oiga la tierra los dichos de
mi boca. \footnote{\textbf{32:1} Deut 31,28; Is 1,2} \bibverse{2}
...
hierba: \footnote{\textbf{32:2} Is 55,10-11} \bibverse{3} Porque el
nombre de Jehová invocaré: engrandeced á nuestro Dios. \bibverse{4} El
...
\bibverse{5} La corrupción no es suya: á sus hijos la mancha de ellos,
generación torcida y perversa. \footnote{\textbf{32:5} Is 1,2-4}
\bibverse{6} ¿Así pagáis á Jehová, pueblo loco é ignorante? ¿no es él tu
padre que te poseyó? él te hizo y te ha organizado. \footnote{\textbf{32:6}
  Éxod 4,22; Is 63,16; Mal 1,6} \bibverse{7} Acuérdate de los tiempos
...
padre, que él te declarará; á tus viejos, y ellos te dirán. \footnote{\textbf{32:7}
  Sal 77,12} \bibverse{8} Cuando el Altísimo hizo heredar á las gentes,
...
los pueblos según el número de los hijos de Israel. \footnote{\textbf{32:8}
  Gén 11,8; Hech 17,26} \bibverse{9} Porque la parte de Jehová es su
pueblo; Jacob la cuerda de su heredad. \bibverse{10} Hallólo en tierra
...
instruyólo, guardólo como la niña de su ojo. \footnote{\textbf{32:10}
  Sal 17,8; Zac 2,12} \bibverse{11} Como el águila despierta su nidada,
revolotea sobre sus pollos, extiende sus alas, los toma, los lleva sobre
sus plumas: \footnote{\textbf{32:11} Sal 36,8; Éxod 19,4} \bibverse{12}
Jehová solo le guió, que no hubo con él dios ajeno. \bibverse{13} Hízolo
...
\footnote{\textbf{32:13} Sal 81,17} \bibverse{14} Manteca de vacas y
...
bebiste, vino puro. \bibverse{15} Y engrosó Jeshurun, y tiró coces:
engordástete, engrosástete, cubrístete: y dejó al Dios que le hizo, y
menospreció la Roca de su salud. \bibverse{16} Despertáronle á celos con
los dioses ajenos; ensañáronle con abominaciones. \bibverse{17}
...
\bibverse{18} De la Roca que te crió te olvidaste: te has olvidado del
Dios tu criador. \bibverse{19} Y viólo Jehová, y encendióse en ira, por
el menosprecio de sus hijos y de sus hijas. \bibverse{20} Y dijo:
Esconderé de ellos mi rostro, veré cuál será su postrimería: que son
generación de perversidades, hijos sin fe. \bibverse{21} Ellos me
...
con gente insensata los haré ensañar. \footnote{\textbf{32:21} Jer 2,11;
  Rom 10,19} \bibverse{22} Porque fuego se encenderá en mi furor, y
arderá hasta el profundo; y devorará la tierra y sus frutos, y abrasará
los fundamentos de los montes. \bibverse{23} Yo allegaré males sobre
ellos; emplearé en ellos mis saetas. \bibverse{24} Consumidos serán de
...
tierra. \bibverse{25} De fuera desolará la espada, y dentro de las
cámaras el espanto; así al mancebo como á la doncella, al que mama como
el hombre cano. \bibverse{26} Dije: Echaríalos yo del mundo, haría cesar
de entre los hombres la memoria de ellos, \bibverse{27} Si no temiese la
ira del enemigo, no sea que se envanezcan sus adversarios, no sea que
digan: Nuestra mano alta ha hecho todo esto, no Jehová. \bibverse{28}
Porque son gente de perdidos consejos, y no hay en ellos entendimiento.
\footnote{\textbf{32:28} Is 27,11; Jer 4,22} \bibverse{29} ¡Ojalá fueran
sabios, que comprendieran esto, y entendieran su postrimería!
\bibverse{30} ¿Cómo podría perseguir uno á mil, y dos harían huir á diez
mil, si su Roca no los hubiese vendido, y Jehová no los hubiera
entregado? \bibverse{31} Que la roca de ellos no es como nuestra Roca: y
nuestros enemigos sean de ello jueces. \bibverse{32} Porque de la vid de
...
ellos son uvas ponzoñosas, racimos muy amargos tienen. \footnote{\textbf{32:32}
  Is 1,10} \bibverse{33} Veneno de dragones es su vino, y ponzoña cruel
de áspides. \bibverse{34} ¿No tengo yo esto guardado, sellado en mis
tesoros? \bibverse{35} Mía es la venganza y el pago, al tiempo que su
...
está preparado se apresura. \footnote{\textbf{32:35} Sal 94,1; Rom
  12,19; Heb 10,30} \bibverse{36} Porque Jehová juzgará á su pueblo, y
...
pereció, y que no hay guardado, mas desamparado. \footnote{\textbf{32:36}
  1Re 14,10} \bibverse{37} Y dirá: ¿Dónde están sus dioses, la roca en
que se guarecían; \bibverse{38} Que comían el sebo de sus sacrificios,
bebían el vino de sus libaciones? Levántense, que os ayuden y os
defiendan. \footnote{\textbf{32:38} Jue 10,14} \bibverse{39} Ved ahora
...
\bibverse{40} Cuando yo alzaré á los cielos mi mano, y diré: Vivo yo
para siempre, \footnote{\textbf{32:40} Éxod 6,8; Ezeq 33,11}
\bibverse{41} Si afilare mi reluciente espada, y mi mano arrebatare el
juicio, yo volveré la venganza á mis enemigos, y daré el pago á los que
me aborrecen. \bibverse{42} Embriagaré de sangre mis saetas, y mi espada
devorará carne: en la sangre de los muertos y de los cautivos de las
cabezas, con venganzas de enemigo. \bibverse{43} Alabad, gentes, á su
...
\bibverse{44} Y vino Moisés, y recitó todas las palabras de este cántico
á oídos del pueblo, él, y Josué hijo de Nun. \bibverse{45} Y acabó
Moisés de recitar todas estas palabras á todo Israel; \bibverse{46} Y
...
\bibverse{47} Porque no os es cosa vana, mas es vuestra vida: y por
ellas haréis prolongar los días sobre la tierra, para poseer la cual
pasáis el Jordán. \footnote{\textbf{32:47} Lev 18,5}

\bibverse{48} Y habló Jehová á Moisés aquel mismo día, diciendo:
\bibverse{49} Sube á este monte de Abarim, al monte Nebo, que está en la
...
Canaán, que yo doy por heredad á los hijos de Israel; \footnote{\textbf{32:49}
  Núm 27,12; Núm 33,48} \bibverse{50} Y muere en el monte al cual subes,
...
monte de Hor, y fué reunido á sus pueblos: \footnote{\textbf{32:50} Núm
  20,23-29} \bibverse{51} Por cuanto prevaricasteis contra mí en medio
...
Israel. \footnote{\textbf{32:51} Núm 20,12-13} \bibverse{52} Verás por
...
\bibverse{1} Y esta es la bendición con la cual bendijo Moisés varón de
Dios á los hijos de Israel, antes que muriese. \footnote{\textbf{33:1}
  Gén 49,-1} \bibverse{2} Y dijo: Jehová vino de Sinaí, y de Seir les
...
á su diestra la ley de fuego para ellos. \footnote{\textbf{33:2} Jds
  1,14} \bibverse{3} Aun amó los pueblos; todos sus santos en tu mano:
ellos también se llegaron á tus pies: recibieron de tus dichos.
\bibverse{4} Ley nos mandó Moisés, heredad á la congregación de Jacob.
\bibverse{5} Y fué rey en Jeshurun, cuando se congregaron las cabezas
...
\bibverse{6} Viva Rubén, y no muera; y sean sus varones en número.

\bibverse{7} Y esta bendición para Judá. Dijo así: Oye, oh Jehová, la
voz de Judá, y llévalo á su pueblo; sus manos le basten, y tú seas ayuda
contra sus enemigos.

\bibverse{8} Y á Leví dijo: Tu Thummim y tu Urim, con tu buen varón, al
cual tentaste en Massa, y le hiciste reñir en las aguas de la rencilla;
\bibverse{9} El que dijo á su padre y á su madre: Nunca los vi: ni
...
guardarán tus palabras, y observarán tu pacto. \footnote{\textbf{33:9}
  Mat 10,37; Éxod 32,26-29} \bibverse{10} Ellos enseñarán tus juicios á
Jacob, y tu ley á Israel; pondrán el perfume delante de ti, y el
holocausto sobre tu altar. \bibverse{11} Bendice, oh Jehová, lo que
...
\bibverse{12} Y á Benjamín dijo: El amado de Jehová habitará confiado
cerca de él; cubrirálo siempre, y entre sus hombros morará.

\bibverse{13} Y á José dijo: Bendita de Jehová su tierra, por los
regalos de los cielos, por el rocío, y por el abismo que abajo yace,
\bibverse{14} Y por los regalados frutos del sol, y por los regalos de
las influencias de las lunas, \bibverse{15} Y por la cumbre de los
montes antiguos, y por los regalos de los collados eternos,
\bibverse{16} Y por los regalos de la tierra y su plenitud; y la gracia
del que habitó en la zarza venga sobre la cabeza de José, y sobre la
mollera del apartado de sus hermanos. \bibverse{17} El es aventajado
...
\bibverse{18} Y á Zabulón dijo: Alégrate, Zabulón, cuando salieres: y
tú, Issachâr, en tus tiendas. \bibverse{19} Llamarán los pueblos al
...
\bibverse{20} Y á Gad dijo: Bendito el que hizo ensanchar á Gad: como
león habitará, y arrebatará brazo y testa. \bibverse{21} Y él se ha
...
\bibverse{22} Y á Dan dijo: Dan, cachorro de león: saltará desde Basán.

\bibverse{23} Y á Nephtalí dijo: Nephtalí, saciado de benevolencia, y
lleno de la bendición de Jehová, posee el occidente y el mediodía.

\bibverse{24} Y á Aser dijo: Bendito Aser en hijos: agradable será á sus
hermanos, y mojará en aceite su pie. \bibverse{25} Hierro y metal tu
...
\bibverse{26} No hay como el Dios de Jeshurun, montado sobre los cielos
para tu ayuda, y sobre las nubes con su grandeza. \bibverse{27} El
eterno Dios es tu refugio, y acá abajo los brazos eternos; él echará de
delante de ti al enemigo, y dirá: Destruye. \bibverse{28} E Israel,
...
\bibverse{29} Bienaventurado tú, oh Israel, ¿quién como tú, pueblo salvo
...
\bibverse{1} Y subió Moisés de los campos de Moab al monte de Nebo, á la
...
\bibverse{2} Y á todo Nephtalí, y la tierra de Ephraim y de Manasés,
toda la tierra de Judá hasta la mar postrera; \bibverse{3} Y la parte
meridional, y la campiña, la vega de Jericó, ciudad de las palmas, hasta
Soar. \bibverse{4} Y díjole Jehová: Esta es la tierra de que juré á
Abraham, á Isaac, y á Jacob, diciendo: A tu simiente la daré. Hétela
hecho ver con tus ojos, mas no pasarás allá.

\bibverse{5} Y murió allí Moisés siervo de Jehová, en la tierra de Moab,
conforme al dicho de Jehová. \footnote{\textbf{34:5} Deut 32,50}
\bibverse{6} Y enterrólo en el valle, en tierra de Moab, enfrente de
Bethpeor; y ninguno sabe su sepulcro hasta hoy. \footnote{\textbf{34:6}
  Jds 1,9} \bibverse{7} Y era Moisés de edad de ciento y veinte años
cuando murió: sus ojos nunca se oscurecieron, ni perdió su vigor.
\bibverse{8} Y lloraron los hijos de Israel á Moisés en los campos de
Moab treinta días: y así se cumplieron los días del lloro del luto de
Moisés. \footnote{\textbf{34:8} Núm 20,29} \bibverse{9} Y Josué hijo de
...
\bibverse{10} Y nunca más se levantó profeta en Israel como Moisés, á
quien haya conocido Jehová cara á cara; \bibverse{11} En todas las
señales y prodigios que le envió Jehová á hacer en tierra de Egipto á
Faraón, y á todos sus siervos, y á toda su tierra; \bibverse{12} Y en
